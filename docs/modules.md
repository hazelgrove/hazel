...
| `src/language/statics/Mark.re`          | `ModuleMissingMembers`, `ModuleTypeMemberMismatch`, `ModuleMemberNotFound`, `ModuleTypeMemberNotFound`, `TypWantModule`, `TypeMemberCapture`, `TypAbstractMemberOfSignature`, `SigDuplicateMember` |
...
| `test/Test_Typ.re`                         | `Typ.Sig`, `Typ.Coercion`, `Typ.SigPaths`, `Typ.SubstCaptures`: meet, coercion, paths, strengthening, capture reporting |

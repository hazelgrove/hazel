...
let literal_tests = [
  ...
  ind(
    ~name="Before multi-digit int",
    ~input={|¦123|},
    ~indicated="123 [R,S]",
  ),
  ind(
    ~name="After multi-digit int",
    ~input={|123¦|},
    ~indicated="123 [L,S]",
  ),
  /* --- Booleans --- */
...
let parens_tests = [
  ...
  ind(
    ~name="Inside parens before content (inward bias: child over parent)",
    ~input={|(¦1)|},
    ~indicated="1 [R,S]",
  ),
  ind(
    ~name="Inside parens after content",
    ~input={|(1¦)|},
    ~indicated="1 [L,S]",
  ),
  ...
  /* --- Nested parens ((1)) --- */
  ind(
    ~name="Nested: before inner parens (inward: child over parent)",
    ~input={|(¦(1))|},
    ~indicated="(1) [R,S]",
  ),
  ind(
    ~name="Nested: inside inner before content (inward: child over parent)",
    ~input={|((¦1))|},
    ~indicated="1 [R,S]",
  ),
  ind(
    ~name="Nested: inside inner after content",
    ~input={|((1¦))|},
    ~indicated="1 [L,S]",
  ),
  ind(
    ~name="Nested: after inner parens",
    ~input={|((1)¦)|},
    ~indicated="(1) [L,S]",
  ),
  /* --- Parens with explicit hole --- */
  ind(
    ~name="Parens with hole: before hole (inward: child over parent)",
    ~input={|(¦?)|},
    ~indicated="? [R,S]",
  ),
  ind(
    ~name="Parens with hole: after hole",
    ~input={|(?¦)|},
    ~indicated="? [L,S]",
  ),
];
...
let binary_op_with_spaces_tests = [
  ...
  ind(
    ~name="Plus: before left operand",
    ~input={|¦1 + 2|},
    ~indicated="1 [R,S]",
  ),
  ind(
    ~name="Plus: after left operand",
    ~input={|1¦ + 2|},
    ~indicated="1 [L,S]",
  ),
  ind(
    ~name="Plus: before operator",
    ~input={|1 ¦+ 2|},
    ~indicated="+ [R,S]",
  ),
  ind(~name="Plus: after operator", ~input={|1 +¦ 2|}, ~indicated="+ [L,S]"),
  ind(
    ~name="Plus: before right operand",
    ~input={|1 + ¦2|},
    ~indicated="2 [R,S]",
  ),
  ind(
    ~name="Plus: after right operand",
    ~input={|1 + 2¦|},
    ~indicated="2 [L,S]",
  ),
  /* --- Subtraction with spaces --- */
  ind(
    ~name="Minus: after left operand",
    ~input={|3¦ - 1|},
    ~indicated="3 [L,S]",
  ),
  ind(
    ~name="Minus: before operator",
    ~input={|3 ¦- 1|},
    ~indicated="- [R,S]",
  ),
  ind(
    ~name="Minus: after operator",
    ~input={|3 -¦ 1|},
    ~indicated="- [L,S]",
  ),
  ind(
    ~name="Minus: before right operand",
    ~input={|3 - ¦1|},
    ~indicated="1 [R,S]",
  ),
  /* --- Multi-char operator: ++ (string concat) --- */
  ind(
    ~name="Concat: after left operand",
    ~input={|"a"¦ ++ "b"|},
    ~indicated={|"a" [L,S]|},
  ),
  ind(
    ~name="Concat: before operator",
    ~input={|"a" ¦++ "b"|},
    ~indicated="++ [R,S]",
  ),
  ind(
    ~name="Concat: inside operator (inner caret)",
    ~input={|"a" +¦+ "b"|},
    ~indicated="++ [R,S]",
  ),
  ind(
    ~name="Concat: after operator",
    ~input={|"a" ++¦ "b"|},
    ~indicated="++ [L,S]",
  ),
  ind(
    ~name="Concat: before right operand",
    ~input={|"a" ++ ¦"b"|},
    ~indicated={|"b" [R,S]|},
  ),
  /* --- Comparison: == (multi-char) --- */
  ind(~name="Equals: after left", ~input={|1¦ == 2|}, ~indicated="1 [L,S]"),
  ind(
    ~name="Equals: before right",
    ~input={|1 == ¦2|},
    ~indicated="2 [R,S]",
  ),
  /* --- Logical operators --- */
  ind(
    ~name="And: before operator",
    ~input={|true ¦&& false|},
    ~indicated="&& [R,S]",
  ),
  ind(
    ~name="Or: before operator",
    ~input={|true ¦|| false|},
    ~indicated={||| [R,S]|},
  ),
  /* --- List cons --- */
  ind(~name="Cons: after head", ~input={|1¦ :: []|}, ~indicated="1 [L,S]"),
  ind(~name="Cons: before tail", ~input={|1 :: ¦[]|}, ~indicated="[] [R,S]"),
  /* --- List concat --- */
  ind(
    ~name="List concat: after left",
    ~input={|[1]¦ @ [2]|},
    ~indicated="[1] [L,S]",
  ),
  ind(
    ~name="List concat: before right",
    ~input={|[1] @ ¦[2]|},
    ~indicated="[2] [R,S]",
  ),
  /* --- Pipeline --- */
  ind(
    ~name="Pipeline: after left",
    ~input={|1¦ |> f|},
    ~indicated="1 [L,S]",
  ),
  ind(
    ~name="Pipeline: before right",
    ~input={|1 |> ¦f|},
    ~indicated="f [R,S]",
  ),
];
...
let binary_op_no_spaces_tests = [
  ...
  ind(
    ~name="Plus no space: after left operand (infix special case)",
    ~input={|1¦+2|},
    ~indicated="+ [R,S]",
  ),
  ind(
    ~name="Plus no space: before right operand (inward bias)",
    ~input={|1+¦2|},
    ~indicated="2 [R,S]",
  ),
  /* --- Times no space --- */
  ind(
    ~name="Times no space: after left (infix special case)",
    ~input={|2¦*3|},
    ~indicated="* [R,S]",
  ),
  ind(
    ~name="Times no space: before right (inward bias)",
    ~input={|2*¦3|},
    ~indicated="3 [R,S]",
  ),
];
...
let type_annotation_tests = [
  ...
  ind(
    ~name="Ascription: after expr",
    ~input={|1¦ : Int|},
    ~indicated="1 [L,S]",
  ),
  ind(
    ~name="Ascription: before colon",
    ~input={|1 ¦: Int|},
    ~indicated=": [R,S]",
  ),
  ind(
    ~name="Ascription: after colon",
    ~input={|1 :¦ Int|},
    ~indicated=": [L,S]",
  ),
  ind(
    ~name="Ascription: before type",
    ~input={|1 : ¦Int|},
    ~indicated="Int [R,S]",
  ),
  ind(
    ~name="Ascription: after type",
    ~input={|1 : Int¦|},
    ~indicated="Int [L,S]",
  ),
];
...
let let_binding_tests = [
  ...
  ind(
    ~name="Let: before let keyword",
    ~input={|¦let x = 1 in x|},
    ~indicated="let x = 1 in [R,S]",
  ),
  ind(
    ~name="Let: after in keyword",
    ~input={|let x = 1 in¦ x|},
    ~indicated="let x = 1 in [L,S]",
  ),
  ind(
    ~name="Let: before body (after space)",
    ~input={|let x = 1 in ¦x|},
    ~indicated="x [R,S]",
  ),
  ind(
  ...
  ind(
    ~name="Let: before pattern (after space)",
    ~input={|let ¦x = 1 in x|},
    ~indicated="x [R,S]",
  ),
  ind(
    ~name="Let: after pattern",
    ~input={|let x¦ = 1 in x|},
    ~indicated="x [L,S]",
  ),
  ind(
    ~name="Let: before bound expr (after space)",
    ~input={|let x = ¦1 in x|},
    ~indicated="1 [R,S]",
  ),
  ind(
    ~name="Let: after bound expr",
    ~input={|let x = 1¦ in x|},
    ~indicated="1 [L,S]",
  ),
];
...
let fun_tests = [
  ...
  ind(
    ~name="Fun: before fun keyword",
    ~input={|¦fun x -> x|},
    ~indicated="fun x -> [R,S]",
  ),
  ind(
    ~name="Fun: before pattern (after space)",
    ~input={|fun ¦x -> x|},
    ~indicated="x [R,S]",
  ),
  ind(
    ~name="Fun: after pattern",
    ~input={|fun x¦ -> x|},
    ~indicated="x [L,S]",
  ),
  ind(
    ~name="Fun: after arrow",
    ~input={|fun x ->¦ x|},
    ~indicated="fun x -> [L,S]",
  ),
  ind(
    ~name="Fun: before body (after space)",
    ~input={|fun x -> ¦x|},
    ~indicated="x [R,S]",
  ),
  ind(~name="Fun: after body", ~input={|fun x -> x¦|}, ~indicated="x [L,S]"),
];
...
let if_tests = [
  ...
  ind(
    ~name="If: before if keyword",
    ~input={|¦if true then 1 else 2|},
    ~indicated="if true then 1 else [R,S]",
  ),
  ind(
    ~name="If: before condition (after space)",
    ~input={|if ¦true then 1 else 2|},
    ~indicated="true [R,S]",
  ),
  ind(
    ~name="If: after condition",
    ~input={|if true¦ then 1 else 2|},
    ~indicated="true [L,S]",
  ),
  ind(
    ~name="If: before then branch (after space)",
    ~input={|if true then ¦1 else 2|},
    ~indicated="1 [R,S]",
  ),
  ind(
    ~name="If: after then branch",
    ~input={|if true then 1¦ else 2|},
    ~indicated="1 [L,S]",
  ),
  ind(
    ~name="If: before else branch (after space)",
    ~input={|if true then 1 else ¦2|},
    ~indicated="2 [R,S]",
  ),
  ind(
    ~name="If: after else branch",
    ~input={|if true then 1 else 2¦|},
    ~indicated="2 [L,S]",
  ),
];
...
let application_tests = [
  ...
  ind(~name="App: before function", ~input={|¦f(1)|}, ~indicated="f [R,S]"),
  ind(
    ~name="App: after function name (concave-left designated position)",
    ~input={|f¦(1)|},
    ~indicated="(1) [R,S]",
  ),
  ind(
    ~name="App: inside app before arg (inward: child over parent)",
    ~input={|f(¦1)|},
    ~indicated="1 [R,S]",
  ),
  ind(
    ~name="App: inside app after arg",
    ~input={|f(1¦)|},
    ~indicated="1 [L,S]",
  ),
  ind(
    ~name="App: after close paren",
    ~input={|f(1)¦|},
    ~indicated="(1) [L,S]",
  ),
  /* --- Nested: f(g(1)) --- */
  ind(
    ~name="Nested app: before inner arg (inward: child over parent)",
    ~input={|f(g(¦1))|},
    ~indicated="1 [R,S]",
  ),
  ind(
    ~name="Nested app: after inner arg",
    ~input={|f(g(1¦))|},
    ~indicated="1 [L,S]",
  ),
  /* --- App inside tuple: (myfun(arg), 1) --- */
  ind(
    ~name="App in tuple: after function name (concave-left designated)",
    ~input={|(myfun¦(arg), 1)|},
    ~indicated="(arg) [R,S]",
  ),
];
...
let list_tests = [
  /* --- [1, 2, 3] --- */
  ind(
    ~name="List: before bracket",
    ~input={|¦[1, 2, 3]|},
    ~indicated="[1, 2, 3] [R,S]",
  ),
  ind(
    ~name="List: before first element (inward: child over parent)",
    ~input={|[¦1, 2, 3]|},
    ~indicated="1 [R,S]",
  ),
  ind(
    ~name="List: after first element (comma infix special case)",
    ~input={|[1¦, 2, 3]|},
    ~indicated=", [R,S]",
  ),
  ind(
    ~name="List: before second element (after space)",
    ~input={|[1, ¦2, 3]|},
    ~indicated="2 [R,S]",
  ),
  ind(
    ~name="List: after last element",
    ~input={|[1, 2, 3¦]|},
    ~indicated="3 [L,S]",
  ),
  ind(
    ~name="List: after bracket",
    ~input={|[1, 2, 3]¦|},
    ~indicated="[1, 2, 3] [L,S]",
  ),
  /* --- Empty list --- */
  ind(~name="Empty list: before", ~input={|¦[]|}, ~indicated="[] [R,S]"),
  ind(~name="Empty list: after", ~input={|[]¦|}, ~indicated="[] [L,S]"),
];
...
let tuple_tests = [
  ...
  ind(
    ~name="Tuple: before parens",
    ~input={|¦(1, 2)|},
    ~indicated="(1, 2) [R,S]",
  ),
  ind(
    ~name="Tuple: before first element (inward: child over parent)",
    ~input={|(¦1, 2)|},
    ~indicated="1 [R,S]",
  ),
  ind(
    ~name="Tuple: after first element (comma infix special case)",
    ~input={|(1¦, 2)|},
    ~indicated=", [R,S]",
  ),
  ind(
    ~name="Tuple: before second element (after space)",
    ~input={|(1, ¦2)|},
    ~indicated="2 [R,S]",
  ),
  ind(
    ~name="Tuple: after second element",
    ~input={|(1, 2¦)|},
    ~indicated="2 [L,S]",
  ),
  ind(
    ~name="Tuple: after parens",
    ~input={|(1, 2)¦|},
    ~indicated="(1, 2) [L,S]",
  ),
];
...
let constructor_tests = [
  ...
  ind(
    ~name="Constructor: before name",
    ~input={|¦Some(1)|},
    ~indicated="Some [R,S]",
  ),
  ind(
    ~name="Constructor: after name (concave-left designated position)",
    ~input={|Some¦(1)|},
    ~indicated="(1) [R,S]",
  ),
  ind(
    ~name="Constructor: before arg (inward: child over parent)",
    ~input={|Some(¦1)|},
    ~indicated="1 [R,S]",
  ),
  ind(
    ~name="Constructor: after arg",
    ~input={|Some(1¦)|},
    ~indicated="1 [L,S]",
  ),
  ind(
    ~name="Constructor: after close paren",
    ~input={|Some(1)¦|},
    ~indicated="(1) [L,S]",
  ),
];
...
let prefix_op_tests = [
  ...
  ind(~name="Negation: before minus", ~input={|¦-1|}, ~indicated="- [R,S]"),
  ind(
    ~name="Negation: between minus and operand (inward bias)",
    ~input={|-¦1|},
    ~indicated="1 [R,S]",
  ),
  ind(~name="Negation: after operand", ~input={|-1¦|}, ~indicated="1 [L,S]"),
  /* --- Logical not: !true --- */
  ind(~name="Not: before bang", ~input={|¦!true|}, ~indicated="! [R,S]"),
  ind(
    ~name="Not: between bang and operand (inward bias)",
    ~input={|!¦true|},
    ~indicated="true [R,S]",
  ),
  ind(
    ~name="Not: after operand",
    ~input={|!true¦|},
    ~indicated="true [L,S]",
  ),
];
...
let precedence_tests = [
  ...
  ind(
    ~name="Precedence: before 1",
    ~input={|¦1 + 2 * 3|},
    ~indicated="1 [R,S]",
  ),
  ind(
    ~name="Precedence: after 1",
    ~input={|1¦ + 2 * 3|},
    ~indicated="1 [L,S]",
  ),
  ind(
    ~name="Precedence: before 2 (after +space)",
    ~input={|1 + ¦2 * 3|},
    ~indicated="2 [R,S]",
  ),
  ind(
    ~name="Precedence: after 2",
    ~input={|1 + 2¦ * 3|},
    ~indicated="2 [L,S]",
  ),
  ind(
    ~name="Precedence: before 3 (after *space)",
    ~input={|1 + 2 * ¦3|},
    ~indicated="3 [R,S]",
  ),
  ind(
    ~name="Precedence: after 3",
    ~input={|1 + 2 * 3¦|},
    ~indicated="3 [L,S]",
  ),
];
...
let case_tests = [
  /* --- case x | 1 => 2 | 3 => 4 end --- */
  ind(
    ~name="Case: before case keyword",
    ~input={|¦case x | 1 => 2 | 3 => 4 end|},
    ~indicated="case x | 1 => 2 | 3 => 4 end [R,S]",
  ),
  ind(
    ~name="Case: before scrutinee (after space)",
    ~input={|case ¦x | 1 => 2 | 3 => 4 end|},
    ~indicated="x [R,S]",
  ),
  ind(
    ~name="Case: after scrutinee",
    ~input={|case x¦ | 1 => 2 | 3 => 4 end|},
    ~indicated="x [L,S]",
  ),
];
...
let whitespace_tests = [
  ...
  ind(~name="Space before operand", ~input={| ¦1|}, ~indicated="1 [R,S]"),
  ind(
    ~name="Trailing space after operand",
    ~input={|1 ¦|},
    ~indicated="<none>",
  ),
  /* --- Multiple spaces between operands --- */
  ind(~name="Between two spaces", ~input={|1  ¦ + 2|}, ~indicated="<none>"),
];
...
let inner_caret_tests = [
  ...
  ind(
    ~name="Inner: middle of variable",
    ~input={|f¦oo|},
    ~indicated="foo [R,S]",
  ),
  ind(
    ~name="Inner: middle of keyword let",
    ~input={|l¦et x = 1 in x|},
    ~indicated="let x = 1 in [R,S]",
  ),
  ind(~name="Inner: middle of int", ~input={|1¦23|}, ~indicated="123 [R,S]"),
  ind(
    ~name="Inner: middle of multi-char op",
    ~input={|1 =¦= 2|},
    ~indicated="== [R,S]",
  ),
];
...
let complex_tests = [
  ...
  ind(
    ~name="Complex: before let",
    ~input={|¦let f = fun x -> x + 1 in f(2)|},
    ~indicated="let f = fun x -> x + 1 in [R,S]",
  ),
  ind(
    ~name="Complex: function body operand",
    ~input={|let f = fun x -> x¦ + 1 in f(2)|},
    ~indicated="x [L,S]",
  ),
  ind(
    ~name="Complex: app arg (inward: child over parent)",
    ~input={|let f = fun x -> x + 1 in f(¦2)|},
    ~indicated="2 [R,S]",
  ),
  /* --- Nested lets --- */
...
let type_arrow_tests = [
  ...
  ind(
    ~name="Type arrow: before left type (after :space)",
    ~input={|1 : ¦Int -> Int|},
    ~indicated="Int [R,S]",
  ),
  ind(
    ~name="Type arrow: after left type",
    ~input={|1 : Int¦ -> Int|},
    ~indicated="Int [L,S]",
  ),
  ind(
    ~name="Type arrow: before right type (after ->space)",
    ~input={|1 : Int -> ¦Int|},
    ~indicated="Int [R,S]",
  ),
  ind(
    ~name="Type arrow: after right type",
    ~input={|1 : Int -> Int¦|},
    ~indicated="Int [L,S]",
  ),
];
...
let semicolon_tests = [
  ...
  ind(
    ~name="Semi: after left expr (semicolon infix special case)",
    ~input={|1¦; 2|},
    ~indicated="; [R,S]",
  ),
  ind(
    ~name="Semi: before right expr (after ;space)",
    ~input={|1; ¦2|},
    ~indicated="2 [R,S]",
  ),
  ind(
    ~name="Semi: after right expr",
    ~input={|1; 2¦|},
    ~indicated="2 [L,S]",
  ),
];
...
let inward_bias_tests = [
  ...
  ind(
    ~name="Parens hole: (¦?) indicates hole for type feedback",
    ~input={|(¦?)|},
    ~indicated="? [R,S]",
  ),
  ind(
    ~name="App hole: f(¦?) indicates hole",
    ~input={|f(¦?)|},
    ~indicated="? [R,S]",
  ),
  ind(
    ~name="List hole: [¦?] indicates hole",
    ~input={|[¦?]|},
    ~indicated="? [R,S]",
  ),
  /* --- Postfix tile right edge: after content, indicate content not parent --- */
  ind(
    ~name="Inside parens at right edge: (1¦) indicates 1",
    ~input={|(1¦)|},
    ~indicated="1 [L,S]",
  ),
  ind(
    ~name="Inside list at right edge: [1¦] indicates 1",
    ~input={|[1¦]|},
    ~indicated="1 [L,S]",
  ),
  /* --- Prefix operators: inward means toward the operand --- */
  ind(
    ~name="Prefix -: inward picks operand",
    ~input={|-¦42|},
    ~indicated="42 [R,S]",
  ),
  ind(
  ...
  ind(
    ~name="Plus gets left position in 1¦+2",
    ~input={|1¦+2|},
    ~indicated="+ [R,S]",
  ),
  ind(
    ~name="Minus gets left position in 3¦-1",
    ~input={|3¦-1|},
    ~indicated="- [R,S]",
  ),
  ind(
    ~name="Comma gets left position in (1¦,2)",
    ~input={|(1¦,2)|},
    ~indicated=", [R,S]",
  ),
  /* --- Multi-token infix operators: same special case as single-token --- */
  ind(
    ~name="Concat ++: infix gets left position",
    ~input={|"a"¦++"b"|},
    ~indicated="++ [R,S]",
  ),
  /* --- Inward at operator right edge picks operand --- */
  ind(
    ~name="After + before 2 (no space): inward picks 2",
    ~input={|1+¦2|},
    ~indicated="2 [R,S]",
  ),
  ind(
    ~name="After * before 3 (no space): inward picks 3",
    ~input={|2*¦3|},
    ~indicated="3 [R,S]",
  ),
  /* --- Let/fun child boundaries: spaces put you inside child --- */
  ind(
    ~name="Let before pattern: in child, indicates pattern",
    ~input={|let ¦x = 1 in x|},
    ~indicated="x [R,S]",
  ),
  ind(
    ~name="Let before body: after space, indicates body",
    ~input={|let x = 1 in ¦x|},
    ~indicated="x [R,S]",
  ),
  ind(
    ~name="Fun before pattern: in child, indicates pattern",
    ~input={|fun ¦x -> x|},
    ~indicated="x [R,S]",
  ),
  ind(
    ~name="If before condition: in child, indicates condition",
    ~input={|if ¦true then 1 else 2|},
    ~indicated="true [R,S]",
  ),
  /* --- Case scrutinee: in child, indicates scrutinee --- */
  ind(
    ~name="Case before scrutinee: in child, indicates scrutinee",
    ~input={|case ¦x | 1 => 2 end|},
    ~indicated="x [R,S]",
  ),
  /* --- Nested delimiters: each level prefers its own child --- */
  ind(
    ~name="Nested: outer paren left edge indicates inner paren",
    ~input={|(¦(1))|},
    ~indicated="(1) [R,S]",
  ),
  ind(
    ~name="Nested: inner paren left edge indicates content",
    ~input={|((¦1))|},
    ~indicated="1 [R,S]",
  ),
];
...
let grout_tests = [
  ...
  ind_acts(
    ~name="Incomplete paren: convex grout indicated (inward)",
    ~acts=string_to_ltr_actions("f("),
    ~indicated="? [R,S]",
  ),
  /* Convex grout: after "1+" — grout is the missing right operand */
  ind_acts(
    ~name="After operator: convex grout indicated (inward)",

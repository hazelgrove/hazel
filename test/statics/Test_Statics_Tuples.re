            ...
            ty_alias(
              ...
              asc(
                ...
                Typ.(
                  prod_projection(
                    var("T"),
                    label(~ann=Some(Marks([Mark.InvalidLabel("b", ["a"])])), "b"),
                  )
                ),
              ),
            )
            ...
            asc(
              ...
              Typ.(
                prod([
                  tup_label(
                    label(
                      ~ann=Some(Marks([Mark.DuplicateLabel("a", FTemp.Typ.label("a"))])),
                      "a",
                    ),
                    int(),
                  ),

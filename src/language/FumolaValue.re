...
let element_anas =
    (~tools: FumolaTools.t, ana: TermBase.Typ.t, arity: int)
    : list(TermBase.Typ.t) =>
...
let order_fields =
    (~tools: FumolaTools.t, ana: TermBase.Typ.t, fields)
...
let wants_symbol = (~tools: FumolaTools.t, ana: TermBase.Typ.t): bool => {

...
/* Create term with Id.invalid (faster than fresh; use for throwaway terms
   that won't be tracked by inference or info_map). */
let temp = (term: 'a): t('a) => {
  term,
  annotation: IdTag.mk_internal([Id.invalid]),
};

 ...
 * Delete this file (together with LegacyBase.re, LegacyBaseV1.re, and the
 * migration sections of scripts/README_migrate_tile_format.md) once
 * tile-datatype has merged to dev and active feature branches have run
 * the recipe in scripts/README_migrate_tile_format.md.

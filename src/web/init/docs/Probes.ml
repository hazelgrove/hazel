  ...
  ( "Probes",
    {
      segment =
        "((Secondary((id \
         ...
         \"))))(Tile((id c5aca7b8-2ac2-4ad7-a9f6-b96ff585f08b)(form(Tok \
         chips))(sort Pat)))(Secondary((id \
         3996e033-1efd-4bc3-803e-27f41a698310)(content(Whitespace\" \
         \")))))((Secondary((id \
         465e8bbb-22af-4b37-ae61-900909b85b3e)(content(Whitespace\" \
         \"))))(Tile((id ef6c156a-4adf-48a2-8b68-bdbc30777e98)(form(Tok \
         10))))(Secondary((id \
         ...
         \"))))(Tile((id cad9f261-ff20-4684-a14a-106a75464920)(form(Tok \
         10))))(Secondary((id \
         ...
         \"))))(Tile((id 4268ce54-6c85-437b-9b15-63122e6fea7c)(form(Tok \
         mult))(sort Pat)))(Secondary((id \
         ...
         3d3a76a5-a2b6-4b6b-85fa-3ee8a3968b56)(form(Tok 1))))(Secondary((id \
         ...
         \"))))(Tile((id 51caee3e-221e-40db-ad65-e637a439247a)(form(Tok \
         2))))(Secondary((id \
         ...
         \"))))(Tile((id 0ca3b65f-3b11-407a-b417-2e78e5438eaf)(form(Tok \
         3)))))))))(Secondary((id \
         ...
         \"))))(Tile((id 5aa6e946-03ed-4a3b-9d24-491cd8a5864b)(form(Tok \
         score))(sort Pat)))(Secondary((id \
         6c5d5b02-44d2-41ac-a98e-05d00534c557)(content(Whitespace\" \
         \")))))((Secondary((id \
         628cdd6f-7884-40dd-bb49-890f12459719)(content(Whitespace\" \
         \"))))(Tile((id 7986153c-3621-4dd7-815f-7a64d7ec5202)(form(Tok \
         chips))))(Secondary((id \
         ...
         \"))))(Tile((id 0a6bfd32-8250-4d83-bd61-f518e0c1b49c)(form(Tok \
         mult))))(Secondary((id \
         ...
         \"))))(Tile((id 7cb44819-5b51-46d9-a0c4-e853ae2850bb)(form(Tok \
         check))(sort Pat)))(Secondary((id \
         ...
         4632e83f-8a17-4298-a518-ed0f36f759f7)(form(Compound Parens))(shards(0 \
         1))(children(((Tile((id \
         aef7b358-b2b8-42dd-a2ea-3f3a339cf570)(form(Tok \
         false))))))))))(model\"()\")))(Secondary((id \
         cf66949f-92c6-463e-b0ce-5f45cc8ca376)(content(Whitespace\"\\n\"))))(Tile((id \
         517d95ce-056d-439f-92fb-0615ce863054)(form(Compound Rule))(sort \
         Rul)(shards(0 1))(children(((Secondary((id \
         c817e3bd-d6ac-4ecc-9853-b04d7ae41f77)(content(Whitespace\" \
         \"))))(Tile((id dffa8450-f604-4b3e-a839-b7a5f010b357)(form(Tok \
         false))(sort Pat)))(Secondary((id \
         b11d2e5c-b410-454b-9e05-3008b0d7828a)(content(Whitespace\" \
         \")))))))))(Secondary((id \
         20c7f399-dd1d-4793-bdb5-abe4c85dc3ef)(content(Whitespace\" \
         \"))))(Tile((id \
         f88f17e5-5cb4-4990-a2b3-4fe672be97a6)(form(Tok\"\\\"checks \
         out\\\"\"))))(Secondary((id \
         b58bd98d-f681-4c5f-bdaf-134d68d97d1a)(content(Whitespace\"\\n\"))))(Tile((id \
         0679ccb1-afd2-4519-bd00-a376f4041474)(form(Compound Rule))(sort \
         Rul)(shards(0 1))(children(((Secondary((id \
         a3f3472b-eadb-4e18-a48f-b988b15e8b73)(content(Whitespace\" \
         \"))))(Tile((id 9dcb9a2b-b52e-48a9-b23f-fe35e8ecfd84)(form(Tok \
         true))(sort Pat)))(Secondary((id \
         c13ac757-5b90-4fca-a855-7dabb6320446)(content(Whitespace\" \
         \")))))))))(Secondary((id \
         39c5c786-be2a-496e-b5cf-ddaec81ff6fc)(content(Whitespace\" \
         \"))))(Tile((id \
         62dee821-0e00-4347-92bf-c6c24e2d502e)(form(Tok\"\\\"you \
         cheated\\\"\"))))(Secondary((id \
         ...
         \"))))(Tile((id 7d9f17c3-9fda-40ba-8933-a3518b9cafc7)(form(Tok \
         pow))(sort Pat)))(Secondary((id \
         b4348e4a-e5c6-4da9-9851-6e9c0fe28e86)(content(Whitespace\" \
         \")))))((Secondary((id \
         6a6fb48c-60bb-4910-8535-a6330e3acf18)(content(Whitespace\" \
         \"))))(Tile((id b35c1912-6812-4c33-9353-14aa49d56d44)(form(Tok \
         50))))(Secondary((id \
         ...
         \"))))(Tile((id a91233b5-0276-49f5-871d-7a5cc02e29a9)(form(Tok \
         2))))(Secondary((id \
         ...
         \"))))(Tile((id 3cf7465d-1389-4875-bfdc-9aa75ccdf5bf)(form(Tok \
         pow))(sort Pat)))(Secondary((id \
         ...
         a2df38a1-1107-442a-83ba-0ff8972aad5e)(form(Compound Parens))(shards(0 \
         1))(children(((Tile((id \
         db8820d3-2147-42ad-808f-769e4b92f9a3)(form(Tok \
         ...
         \"))))(Tile((id 03fb3345-cd3f-47f4-bb8a-d5cdbcd2f607)(form(Tok \
         2))))(Secondary((id \
         ...
         \"))))(Tile((id f65dfcb1-f93d-49f8-9a52-6a0fda7fba24)(form(Tok \
         celsius))(sort Pat)))(Secondary((id \
         ...
         \"))))(Tile((id 432678e2-b003-4c8f-929d-aa39171671ae)(form(Tok \
         farenheit))(sort Pat)))(Secondary((id \
         ...
         \"))))(Tile((id a1f3b0a1-4cb4-4f74-9fd3-1adbdc351376)(form(Tok \
         diff))(sort Pat)))(Secondary((id \
         54774f62-c35d-4436-8174-0733eea33b66)(content(Whitespace\" \
         \")))))((Secondary((id \
         fc5fe903-4d6f-421a-8b88-baf52df74d13)(content(Whitespace\" \
         \"))))(Tile((id 5274acd0-d78f-40d1-af3a-cdc064ab63e8)(form(Tok \
         farenheit))))(Secondary((id \
         ...
         \"))))(Tile((id 1c7c00b6-5add-4c37-a4ed-81250d6f020e)(form(Tok \
         32.))))(Secondary((id \
         ...
         70134f76-dc4d-45a2-9f99-720223c113e9)(form(Tok 5.))))(Tile((id \
         b458af94-8e78-4a18-b005-95fdbbf2efa6)(form(Compound \
         FDivide))))(Tile((id 4ee632a7-36f7-4be7-941d-3393c98a3d12)(form(Tok \
         9.))))(Secondary((id \
         ...
         \"))))(Tile((id 80ea6324-0f71-4290-9898-f699fc1341a7)(form(Tok \
         diff))))(Secondary((id \
         ...
         330e8372-5e9f-4049-9020-a6885c9d10be)(form(Tok celsius))))(Tile((id \
         844f3cca-f187-437f-ba24-ed2ac48e6890)(form(Compound Ap))(shards(0 \
         1))(children(((Tile((id \
         de62a279-5fa3-46a6-ae8f-986fd15cae1f)(form(Tok 72.5)))))))))(Tile((id \
         ...
         423f10e5-c69f-4c77-877c-9a1045b60c63)(form(Tok celsius))))(Tile((id \
         4b8f419f-d1f2-444f-989f-a7bee1bb6718)(form(Compound Ap))(shards(0 \
         1))(children(((Tile((id \
         adc472aa-5bf4-43d3-a788-835f16750a19)(form(Tok \
         103.1)))))))))(Tile((id \
         ...
         \"))))(Tile((id 78050494-25eb-49a6-a42d-a67b476b6951)(form(Tok \
         cases))(sort Pat))))((Secondary((id \
         ...
         \"))))(Tile((id 0626cd00-4c2d-426c-988a-ff577e24b50c)(form(Tok \
         ...
         \"))))(Tile((id 49591759-40f8-4171-8690-b400dde5ecce)(form(Tok \
         x))))(Secondary((id \
         ...
         ef1d5d7b-61e7-43da-8dce-62e80cbf2727)(form(Compound Rule))(sort \
         Rul)(shards(0 1))(children(((Secondary((id \
         0c6989b0-214b-46f7-b1a6-2da5ef74ca47)(content(Whitespace\" \
         \"))))(Tile((id 63e90f36-c417-431e-8650-73183dd8ce10)(form(Tok \
         4))(sort Pat)))(Secondary((id \
         c6added0-30b6-4fcd-ae76-b5f6f0cf3ffb)(content(Whitespace\" \
         \")))))))))(Secondary((id \
         e1a58592-7397-49b0-a926-7b5f4063d185)(content(Whitespace\" \
         \"))))(Tile((id 7bff023c-81e0-40e4-b35c-d31f668c1694)(form(Tok \
         true))))(Secondary((id \
         ...
         70e835b3-e7a0-4bf8-91a0-1e110153a9cc)(form(Compound Rule))(sort \
         Rul)(shards(0 1))(children(((Secondary((id \
         0bb8dfc9-9ca8-403e-b46e-dfba09bc7d94)(content(Whitespace\" \
         \"))))(Tile((id 5223a7d5-d431-45f1-9b73-bae0a887d775)(form(Tok \
         5))(sort Pat)))(Secondary((id \
         71befb5d-6dc8-44e5-a9a2-a3875b63e0fb)(content(Whitespace\" \
         \")))))))))(Secondary((id \
         a2bbb70a-8a3a-4700-b5b3-29fed0ba5348)(content(Whitespace\" \
         \"))))(Tile((id 4e4d4917-2ec5-4fc4-831e-8c80b55e59ab)(form(Tok \
         false))))(Secondary((id \
         ...
         ce499445-6d5a-43f9-875e-b8fceadf7c9d)(form(Compound Rule))(sort \
         Rul)(shards(0 1))(children(((Secondary((id \
         b904440f-8a05-4b34-b494-41b9b84aa60a)(content(Whitespace\" \
         \"))))(Tile((id 79f75f34-5323-4007-9015-50052b98139d)(form(Tok \
         ...
         \"))))(Tile((id ff10e8b0-9129-485b-be57-b4c3db20f9fd)(form(Tok \
         true))))(Secondary((id \
         ...
         7c5710dd-0de9-4e93-a16c-1a6d3d926162)(form(Tok cases))))(Tile((id \
         e5f88e23-0af6-44c8-8314-b2715acddf1a)(form(Compound Ap))(shards(0 \
         1))(children(((Tile((id \
         d0b5fc5e-6e99-4edd-8efd-772d0ad6ee63)(form(Tok 4)))))))))(Tile((id \
         ...
         6cefd566-da5e-4ddd-bacb-27802361084d)(form(Tok cases))))(Tile((id \
         d5b36fad-cc60-4fc3-bd5f-965e2a4b851c)(form(Compound Ap))(shards(0 \
         1))(children(((Tile((id \
         fc4d9314-ef93-429e-bae8-ca347b65e436)(form(Tok 5)))))))))(Tile((id \
         0f44dcda-4be1-4e56-9db3-cfc97ba054dc)(form(Compound \
         CellJoin))))(Secondary((id \
         80ca5f13-607c-4974-a988-30c808349fab)(content(Whitespace\"\\n\"))))(Tile((id \
         7442905f-f3e9-4c5e-a91e-172a9b5cb1e0)(form(Tok cases))))(Tile((id \
         2e9f13dd-bf9e-4460-aa4a-595aec41e4d4)(form(Compound Ap))(shards(0 \
         1))(children(((Tile((id \
         ca51ab21-5f9f-431b-9189-e3dea8272dcc)(form(Tok 6)))))))))(Tile((id \
         ...
         \"))))(Tile((id a7c2ec78-b9ca-4d86-8cb0-3d7d9e3539aa)(form(Tok \
         fourth))(sort Pat)))(Secondary((id \
         ...
         \"))))(Tile((id 283dfaa2-dc73-4e43-9766-5ea17b0f7144)(form(Tok \
         ...
         \"))))(Tile((id 00248684-1785-4fc0-b510-07b597d4130c)(form(Tok \
         4))))(Secondary((id \
         ...
         \"))))(Tile((id fee57206-6adf-4779-85b3-5e32590f7984)(form(Tok \
         f))))(Secondary((id \
         ...
         \"))))(Tile((id 5ce632e2-368d-4b60-8265-7dff74ed586e)(form(Tok \
         4))))(Secondary((id \
         ...
         \"))))(Tile((id df00ee64-2091-4170-98e7-d01fc02b1ac3)(form(Tok \
         third))(sort Pat)))(Secondary((id \
         ...
         \"))))(Tile((id 4dffc221-bdfc-4b1f-bef2-ccc125be0d6b)(form(Tok \
         ...
         \"))))(Tile((id 00a17bd2-d8ae-4727-b9dc-b69239605684)(form(Tok \
         fourth))))(Tile((id \
         bc40a889-5015-4f96-b4c4-c241dc99dcf8)(form(Compound Ap))(shards(0 \
         1))(children(((Tile((id \
         0bb0bcec-f448-4bf4-9636-2589684e8d3d)(form(Tok t))))(Secondary((id \
         ...
         \"))))(Tile((id ef072a75-985b-41bf-8e9f-dbd615af38e0)(form(Tok \
         3)))))))))(Secondary((id \
         ...
         \"))))(Tile((id c51a5645-11c5-4f50-a827-7e133aa4af8a)(form(Tok \
         3))))(Secondary((id \
         ...
         \"))))(Tile((id d497eace-caa4-47ad-b2b6-420ab3dc4b8b)(form(Tok \
         ...
         \"))))(Tile((id 65b5c2ad-44f8-4987-aac5-933eace8f60b)(form(Tok \
         s))(sort Pat)))(Secondary((id \
         9721d121-e28b-4201-a4db-8adf084cef1c)(content(Whitespace\" \
         \")))))))))(Secondary((id \
         57cbac08-fe14-437d-b032-391626018c4a)(content(Whitespace\" \
         \"))))(Tile((id f376eef8-0d05-4582-b12d-e8e17744bed2)(form(Tok \
         third))))(Tile((id \
         b90334ea-5ed9-4fb5-8ed3-9e50663acabc)(form(Compound Ap))(shards(0 \
         1))(children(((Tile((id \
         01929910-0800-40b4-b2e9-791cd05514a1)(form(Tok 2))))(Secondary((id \
         ...
         \"))))(Tile((id 8d3853ff-c961-4ecc-b37c-1f5118847c04)(form(Tok \
         s)))))))))(Secondary((id \
         ...
         \"))))(Tile((id 37751a91-d52a-468c-af5b-18714e1705f8)(form(Tok \
         2))))(Secondary((id \
         ...
         \"))))(Tile((id 1a0a5441-1ad9-42af-b945-94caa7caab16)(form(Tok \
         first))(sort Pat)))(Secondary((id \
         ...
         \"))))(Tile((id 3e0af08c-1ff3-4019-8503-cd4b1fe9707d)(form(Tok \
         f))(sort Pat)))(Secondary((id \
         13f8ca0f-219b-4c4a-bec4-9492a03ff3db)(content(Whitespace\" \
         \")))))))))(Secondary((id \
         1fa58b72-2d36-433a-8d0d-d9e3229f4f27)(content(Whitespace\" \
         \"))))(Tile((id 23564024-9865-483d-99ec-fe2f9ac79bcd)(form(Tok \
         second))))(Tile((id \
         fe88043d-71e3-4182-97c8-55396edd1859)(form(Compound Ap))(shards(0 \
         1))(children(((Tile((id \
         0d0083a2-0a86-49f9-afb8-d653fef6d779)(form(Tok f))))(Secondary((id \
         ...
         \"))))(Tile((id 898af5b5-1e12-48f2-bbeb-fdd41f1c3ce4)(form(Tok \
         1)))))))))(Secondary((id \
         ...
         \"))))(Tile((id 247deefd-4015-494b-92d2-15cfb8658102)(form(Tok \
         2))))(Secondary((id \
         ...
         b0020a12-9731-4c07-a095-93fa3f48f415)(form(Tok first))))(Tile((id \
         a67d5e4e-80b8-412d-886a-d7b67426d9a1)(form(Compound Ap))(shards(0 \
         1))(children(((Tile((id \
         fa4cbf11-ac4c-4ab0-b055-1f13ebe59b42)(form(Tok 5)))))))))(Tile((id \
         ...
         \"))))(Tile((id 6db8a5f2-3dbe-4dfc-82ec-97564eafbce8)(form(Tok \
         fact))(sort Pat)))(Secondary((id \
         ...
         \"))))(Tile((id 77e64c06-f45f-4939-9cfe-02f10f352d3e)(form(Tok \
         x))(sort Pat)))(Secondary((id \
         ...
         \"))))(Tile((id 616b5a02-5ce3-44d1-b371-50cff0b93dc6)(form(Tok \
         x))))(Secondary((id \
         670ce8bf-80c2-4f98-bec2-9d515ef892d2)(content(Whitespace\"\\n\"))))(Tile((id \
         69b387f7-eb49-41f9-93d0-af6f6b3b3aad)(form(Compound Rule))(sort \
         Rul)(shards(0 1))(children(((Secondary((id \
         b4b58334-eb23-4f8d-a7eb-3730a2efa116)(content(Whitespace\" \
         \"))))(Tile((id 4515a8f3-fd21-4eb5-8542-1ed1f18d5fdb)(form(Tok \
         1))(sort Pat)))(Secondary((id \
         566af644-bcb3-444f-af84-bc9d2e4b495d)(content(Whitespace\" \
         \")))))))))(Secondary((id \
         09dfb98a-cc65-45b1-916c-977e8aadc27a)(content(Whitespace\" \
         \"))))(Tile((id e0a89cf4-22ce-497d-8a6e-8148403fffea)(form(Tok \
         1))))(Secondary((id \
         b2aff38d-072c-4b3b-ad7f-a9565fc3e5be)(content(Whitespace\"\\n\"))))(Tile((id \
         e3d5ff6e-726c-482b-b8d5-82198dea3a88)(form(Compound Rule))(sort \
         Rul)(shards(0 1))(children(((Secondary((id \
         2735f222-8a06-45bb-ae74-0a9dca7dd0f2)(content(Whitespace\" \
         \"))))(Tile((id 71d9d521-ad13-4287-bb57-6fc316774ccb)(form(Tok \
         _))(sort Pat)))(Secondary((id \
         ...
         \"))))(Tile((id 031a614b-ae61-4102-99f7-fdc9919ba231)(form(Tok \
         ...
         \"))))(Tile((id 26b61323-c51b-4602-a493-09e9f0ea7c39)(form(Tok \
         fact))))(Tile((id e6a41a31-c805-487b-b3ec-1601c0cf0d69)(form(Compound \
         Ap))(shards(0 1))(children(((Tile((id \
         ad412450-5bee-4b0e-afcb-ab221b2fa6c0)(form(Tok x))))(Tile((id \
         c411030f-c1e9-4054-b842-bb7293f06bce)(form(Compound \
         Minus))))(Tile((id 14e82764-ff95-4f30-9fba-250c15cf5ec6)(form(Tok \
         1)))))))))(Secondary((id \
         ...
         \"))))(Tile((id f6d2a397-5a73-4a5a-9876-1577a5a44737)(form(Tok \
         x))))(Tile((id 5bfc6498-5130-4c42-af46-3de7ba8a89d2)(form(Compound \
         Times))))(Tile((id d6f58599-f7c4-455a-8c1e-1c54d85b0d10)(form(Tok \
         r))))(Secondary((id \
         ...
         \"))))(Tile((id cc9b8113-9eb1-41f2-ab6f-6033f6e3d8d2)(form(Tok \
         fact))))(Tile((id da22fe5f-3b3b-4eba-89c2-d4a85b406261)(form(Compound \
         Ap))(shards(0 1))(children(((Tile((id \
         4bc94c00-975b-4339-97b1-632365595a3f)(form(Tok \
         5)))))))))(Secondary((id \
         ...
         \"))))(Tile((id fe11699f-8c68-4172-8a6c-1cc6f41b8f04)(form(Tok \
         120))))(Secondary((id \
         ...
         \"))))(Tile((id 858bdcf7-6f37-4369-8b50-32aebb71d407)(form(Tok \
         fact1))(sort Pat)))(Secondary((id \
         ...
         \"))))(Tile((id 931723cd-f2c7-4b6b-af13-d8917a7dc165)(form(Tok \
         ...
         4a35fd8a-a335-4904-a19d-21f0b9c08d30)(form(Tok x))(sort \
         Pat)))(Tile((id 2dae6b4c-34f8-42d0-b59d-a5dfb55d7a0a)(form(Compound \
         ...
         \"))))(Tile((id 615525df-2f4a-4abb-a692-9c650293dad9)(form(Tok \
         acc))(sort Pat))))))))(Secondary((id \
         ...
         \"))))(Tile((id 98e7546b-e656-4b47-8a35-2a9d5168d629)(form(Tok \
         x))))(Secondary((id \
         7cfd7481-96a0-4c4e-b356-ab313b966581)(content(Whitespace\"\\n\"))))(Tile((id \
         1ecbc9f7-479f-4ed1-abcd-e50591000014)(form(Compound Rule))(sort \
         Rul)(shards(0 1))(children(((Secondary((id \
         a6013378-0d96-4746-bc37-4a11095325cd)(content(Whitespace\" \
         \"))))(Tile((id 82ee1230-80d3-4be9-bef1-c916413a61ec)(form(Tok \
         1))(sort Pat)))(Secondary((id \
         e6a63dd0-9be3-4281-9cd1-7c46a80d7e35)(content(Whitespace\" \
         \")))))))))(Secondary((id \
         6c13db27-151a-4a8b-a617-62ca57bc8580)(content(Whitespace\" \
         \"))))(Tile((id 8b2e95fc-700c-4c6c-af0b-18a256081433)(form(Tok \
         acc))))(Secondary((id \
         88ff7c60-9b8f-465d-8ca2-6f240dbfe25c)(content(Whitespace\"\\n\"))))(Tile((id \
         0c7d42b0-180d-4a99-91bb-b46db3b63795)(form(Compound Rule))(sort \
         Rul)(shards(0 1))(children(((Secondary((id \
         57b80ab7-e5e3-4eab-b4f4-93132c175ae2)(content(Whitespace\" \
         \"))))(Tile((id d3f994ab-0ae0-4af3-97a8-23419f30bad3)(form(Tok \
         _))(sort Pat)))(Secondary((id \
         ...
         \"))))(Tile((id 91cf638e-8c3b-44ea-9d4f-e7ae151ad466)(form(Tok \
         r))(sort Pat)))(Secondary((id \
         42752e64-7801-405b-a1e9-0dd99a95d5d1)(content(Whitespace\" \
         \")))))((Secondary((id \
         2d47505e-9a59-4ba9-94cb-a5230440ed8c)(content(Whitespace\" \
         \"))))(Tile((id 3d889595-15c6-43f2-bc0c-5be66555a8b1)(form(Tok \
         x))))(Tile((id 6c9c978c-87ee-41c1-b594-9814f943494f)(form(Compound \
         Times))))(Tile((id ad2c0faa-7c62-433b-996d-dc5a526a24b6)(form(Tok \
         acc))))(Secondary((id \
         ...
         \"))))(Tile((id b3af13ed-f95f-4a75-ad05-d31eadb58cb8)(form(Tok \
         go))))(Tile((id fc8ade99-f204-427a-a04c-dbff59303e6f)(form(Compound \
         Ap))(shards(0 1))(children(((Tile((id \
         2827313c-50ab-4bfa-bde3-8eb69d0e89b7)(form(Tok x))))(Tile((id \
         a8c3ed7a-af1d-47ce-b148-4afbe903f326)(form(Compound \
         Minus))))(Tile((id 1a353b46-499a-4f96-874f-10936d5412d6)(form(Tok \
         1))))(Tile((id b46c44d7-2a99-42ac-b3f5-a480f5fb2a9e)(form(Compound \
         Comma))))(Secondary((id \
         cfee8131-5b19-42d6-bd3d-d855ffb8e628)(content(Whitespace\" \
         \"))))(Tile((id 504a9030-146c-419c-a73b-ca9e7ab53d1d)(form(Tok \
         r)))))))))(Secondary((id \
         ...
         \"))))(Tile((id 91b27be8-541b-4c55-87eb-a351d70a6e92)(form(Tok \
         x))(sort Pat)))(Secondary((id \
         241d96f1-852c-471c-b0fb-2c93e0598b36)(content(Whitespace\" \
         \")))))))))(Secondary((id \
         b1ae9ebb-06f7-433f-8d7b-7d7932b97edf)(content(Whitespace\" \
         \"))))(Tile((id f5731f06-0eae-40f6-9ba8-10d806b65c31)(form(Tok \
         go))))(Tile((id 2a92dd5a-5d32-4f24-bba7-15078ac38f6b)(form(Compound \
         Ap))(shards(0 1))(children(((Tile((id \
         987ff3dd-da24-41a2-9aab-341e210ba5a8)(form(Tok x))))(Tile((id \
         b2e75dd3-0fe7-4ee0-952d-a2499cab830c)(form(Compound \
         Comma))))(Tile((id ec8f97a5-43c9-48a5-842f-267943b7c711)(form(Tok \
         1)))))))))(Secondary((id \
         ...
         \"))))(Tile((id 10fb8a16-9c8f-454e-aed3-9aa2eb1d9c30)(form(Tok \
         fact1))))(Tile((id \
         b8c77cc2-f714-448f-8523-c50b68f0eb23)(form(Compound Ap))(shards(0 \
         1))(children(((Tile((id \
         50eed1a6-4378-4cf3-9d93-f4a8fc18bb4b)(form(Tok \
         5)))))))))(Secondary((id \
         ...
         \"))))(Tile((id dace8206-c5de-4748-80f1-77ae618b8f7b)(form(Tok \
         120))))(Secondary((id \
         ...
         \"))))(Tile((id 82c1e6e7-8462-428a-bff4-53dee48f305c)(form(Tok \
         fib))(sort Pat)))(Tile((id \
         04c1f1c6-3eeb-4539-a257-3e38a1d0adf4)(form(Compound TypeAsc))(sort \
         Pat)))(Secondary((id \
         2308914a-8387-423a-b7b8-47b36be834d9)(content(Whitespace\" \
         \"))))(Tile((id aa764695-cf75-4b50-b159-2e2ba9c44140)(form(Tok \
         ...
         \"))))(Tile((id fc1c61ad-3d81-4c1b-a3ed-71fc12aaf24f)(form(Tok \
         Int))(sort Typ)))(Secondary((id \
         ...
         \"))))(Tile((id e8f8db93-f6c8-452d-b179-93ae3dfd7a3c)(form(Tok \
         x))(sort Pat)))(Secondary((id \
         ...
         bf090a3c-23c9-4801-b4b3-16e54fe21ae6)(form(Tok fib))))(Tile((id \
         969478fb-f2c6-49bb-9d49-bfefa775775d)(form(Compound Ap))(shards(0 \
         1))(children(((Tile((id \
         fd56b6db-5869-440b-9a0a-e9ebb226d744)(form(Tok x))))(Tile((id \
         57ea6961-e5fd-493c-8dfd-3503c3a154ee)(form(Compound \
         Minus))))(Tile((id a122ee98-7477-4df8-87be-0e46ec0a1015)(form(Tok \
         1)))))))))(Secondary((id \
         ...
         \"))))(Tile((id 0d6af880-6e35-4158-8b17-3e06641be1a5)(form(Tok \
         fib))))(Tile((id 53c37d22-9bc8-45b8-8922-490a01b60591)(form(Compound \
         Ap))(shards(0 1))(children(((Tile((id \
         f99559d9-d5de-47b4-97b0-dcbe1f9fd583)(form(Tok x))))(Tile((id \
         e125f2e6-6f9d-43da-ab2c-019904387632)(form(Compound \
         Minus))))(Tile((id be47f463-ad41-4636-9eac-1098f35dcf19)(form(Tok \
         2)))))))))(Secondary((id \
         ...
         \"))))(Tile((id 6edb49b7-669b-4bf8-96ed-8e2853d30055)(form(Tok \
         fib))))(Tile((id efcd0d68-8ae7-4917-bd8e-b802c19bb8c4)(form(Compound \
         Ap))(shards(0 1))(children(((Tile((id \
         390748de-a0fb-41fb-a24b-6078df3e4662)(form(Tok \
         1)))))))))(Secondary((id \
         ...
         \"))))(Tile((id 88e04c9c-cd80-4105-aa21-90112ebda8ef)(form(Tok \
         1))))(Secondary((id \
         ...
         \"))))(Tile((id 4a31ade5-77f1-4aae-acd1-e9069e931275)(form(Tok \
         fib))))(Tile((id 8a4099c8-4740-4912-9cc5-e82a42d562ca)(form(Compound \
         Ap))(shards(0 1))(children(((Tile((id \
         b5b8a0ce-c3b3-4837-97ca-7ccae11649d1)(form(Tok \
         2)))))))))(Secondary((id \
         ...
         \"))))(Tile((id 8fbe457e-9950-4e1d-9bf2-d193d05068f7)(form(Tok \
         2))))(Secondary((id \
         ...
         \"))))(Tile((id ec085b97-be31-4ba0-8deb-2ab3dec17965)(form(Tok \
         fib))))(Tile((id 01b8885d-2bb0-4d1b-89df-d1723fcc919f)(form(Compound \
         Ap))(shards(0 1))(children(((Tile((id \
         897d17fe-2c5f-4fe3-b9fe-0e7f6cf176e6)(form(Tok \
         3)))))))))(Secondary((id \
         ...
         \"))))(Tile((id 13261013-4bfa-4169-9179-a3e0cc2b3bb9)(form(Tok \
         3))))(Secondary((id \
         ...
         \"))))(Tile((id 5c718870-417a-4bb2-b3a7-98dbd089104e)(form(Tok \
         fib))))(Tile((id 4fe7caa5-a1ba-4d21-84b8-0d476f200796)(form(Compound \
         Ap))(shards(0 1))(children(((Tile((id \
         35de7f36-35b1-4c5d-a871-52533b5d8a59)(form(Tok \
         4)))))))))(Secondary((id \
         ...
         \"))))(Tile((id 021abc8d-0886-4554-b0f3-011b776b6802)(form(Tok \
         5))))(Secondary((id \
         ...
         \"))))(Tile((id 5c697604-e8ac-41be-a763-d713df2390f2)(form(Tok \
         fib))))(Tile((id 842bacd1-013f-4385-91aa-651cc90a073b)(form(Compound \
         Ap))(shards(0 1))(children(((Tile((id \
         14942527-410c-42a3-a301-cb01d824ba14)(form(Tok \
         5)))))))))(Secondary((id \
         ...
         \"))))(Tile((id 99ee73d9-0e5e-4b6e-8c32-075a12eada41)(form(Tok \
         8))))(Secondary((id \
         ...
         \"))))(Tile((id 301ff24b-3127-45c1-92c2-570dfd4180bb)(form(Tok \
         fib))))(Tile((id 72a9b1b8-55a7-4cf8-b254-42b8c12105de)(form(Compound \
         Ap))(shards(0 1))(children(((Tile((id \
         95c95c86-995a-4512-88a4-eaa821bab9e2)(form(Tok \
         6)))))))))(Secondary((id \
         ...
         \"))))(Tile((id 99ba2f3e-6d0a-4eb9-8e6c-802b0d242d5f)(form(Tok \
         13))))(Secondary((id \
         ...
         \"))))(Tile((id 0756f318-9373-4ff2-94cc-f4a8fababba6)(form(Tok \
         frunk_factory))(sort Pat)))(Secondary((id \
         ...
         \"))))(Tile((id 9fb2ec12-1a8f-40d1-82e9-9583f245a839)(form(Tok \
         ...
         \"))))(Tile((id 7ad2b68e-8141-4e0a-ac6c-415009b02ab2)(form(Tok \
         factor))(sort Pat)))(Secondary((id \
         f9982cc9-c189-4a59-b894-1782fac2a953)(content(Whitespace\" \
         \")))))((Secondary((id \
         752ac947-23a7-4d8a-9e68-3062af1576f8)(content(Whitespace\"\\n\"))))(Tile((id \
         9e19d2e4-8f74-42cb-bc68-72123ef39d95)(form(Tok 4))))(Secondary((id \
         ...
         \"))))(Tile((id 0ee39cb3-9bae-4592-8627-4986e16985e1)(form(Tok \
         10))))(Secondary((id \
         ...
         \"))))(Tile((id 4270ac87-70ab-48bf-b807-3a109346ea67)(form(Tok \
         y))))(Secondary((id \
         ...
         \"))))(Tile((id f148c851-4abf-4793-9a4f-502e7e4e7d73)(form(Tok \
         refactor))(sort Pat)))(Secondary((id \
         ...
         \"))))(Tile((id 561db6f3-ff1a-4862-a983-94a79117d26a)(form(Tok \
         x))(sort Pat)))(Secondary((id \
         8b2e5669-5c19-4e01-8849-cce2bce1124a)(content(Whitespace\" \
         \")))))))))(Secondary((id \
         7ff3b744-e038-416c-9700-6d8edde1c748)(content(Whitespace\"\\n\"))))(Tile((id \
         0bd3fa2c-1f50-4ed1-aa52-096d397063d1)(form(Tok x))))(Secondary((id \
         ...
         \"))))(Tile((id 5588b3b3-1fe9-4688-a116-adde16bd3697)(form(Tok \
         factor))))(Secondary((id \
         ...
         \"))))(Tile((id f5827cd3-7ab1-4ae2-9bf8-02c339ea29f0)(form(Tok \
         factor))(sort Pat)))(Secondary((id \
         896242fd-c04a-4f4f-9795-74a7232738cb)(content(Whitespace\" \
         \")))))((Secondary((id \
         41341654-fb59-4c2b-a03b-a14c641f5df6)(content(Whitespace\"\\n\"))))(Tile((id \
         2acde3a8-26b2-4d7d-9d24-5d625fdbe76c)(form(Tok refactor))))(Tile((id \
         70a76ec7-aa87-41ae-be8a-00c056530847)(form(Compound Ap))(shards(0 \
         1))(children(((Tile((id \
         5ed5e53c-aeca-4740-8043-fad57e903212)(form(Tok \
         factor)))))))))(Secondary((id \
         ...
         \"))))(Tile((id f8e77292-468b-4a85-8936-33bd807b974a)(form(Tok \
         refactor))))(Tile((id \
         df5e5c71-f3ba-45db-bc50-8c2d40b622f9)(form(Compound Ap))(shards(0 \
         1))(children(((Tile((id \
         8fbac798-d0bb-4351-a334-3430fffdf752)(form(Tok \
         y)))))))))(Secondary((id \
         ...
         \"))))(Tile((id 391ddb62-2208-4b7a-ab09-6dabfecb8b96)(form(Tok \
         perturb))(sort Pat)))(Secondary((id \
         ...
         \"))))(Tile((id e5202287-c66f-408f-988a-626bb1efdb6c)(form(Tok \
         refactor))))(Tile((id \
         7c272680-423c-49ae-b69e-82876bb0cca2)(form(Compound Ap))(shards(0 \
         1))(children(((Tile((id \
         7b54a486-e0c4-464f-b35b-1bd58f008486)(form(Tok \
         s)))))))))(Secondary((id \
         ...
         \"))))(Tile((id 7dc6e084-2041-4274-abda-56af9d87cda8)(form(Tok \
         ...
         805e5ea6-8d2a-4492-90ca-8b3cfed367e1)(form(Tok perturb))))(Tile((id \
         bdca8131-8820-4f84-97d3-f6bd16fa869b)(form(Compound Ap))(shards(0 \
         1))(children(((Tile((id \
         e01e1b05-5ba1-4eba-9ad0-529a05cdb22b)(form(Tok 3))))(Tile((id \
         ecac6125-f229-4909-b003-710a5aa2555c)(form(Compound \
         Times))))(Tile((id ce4dbfca-daaf-45aa-8f2a-8cd4b6323721)(form(Tok \
         z)))))))))(Secondary((id \
         ...
         \"))))(Tile((id a75af913-7ade-41cd-8787-ac0479d92677)(form(Tok \
         perturb))))(Tile((id \
         f6a2babc-35d4-4335-9527-7613c5f3515b)(form(Compound Ap))(shards(0 \
         1))(children(((Tile((id \
         017e6e2b-94fa-49f9-9cc9-f995bd284647)(form(Tok 5))))(Tile((id \
         faff3e9a-8dd8-468f-81f6-bfeeb2307744)(form(Compound \
         Times))))(Tile((id ba72d8f5-2c8e-4877-bb38-bd274c5bd2c1)(form(Tok \
         z)))))))))(Secondary((id \
         ...
         \"))))(Tile((id 77dec310-6eda-46e8-9e31-ac9ac6214fff)(form(Tok \
         new_frunk))(sort Pat)))(Secondary((id \
         fcb5cb69-fbfd-4f8d-be8d-e5b5148e5f4d)(content(Whitespace\" \
         \")))))((Secondary((id \
         c257e6f6-139d-4444-bb0c-e344b815a625)(content(Whitespace\" \
         \"))))(Tile((id 106d4bd1-5ca1-4bfa-9e28-b07382dec01e)(form(Tok \
         frunk_factory))))(Tile((id \
         6adf9172-943b-4bbc-a791-84e06ff24ba5)(form(Compound Ap))(shards(0 \
         1))(children(((Tile((id \
         05173bf3-439e-44e1-8e67-c8dc64f1b115)(form(Tok \
         7)))))))))(Secondary((id \
         ...
         \"))))(Tile((id 45f25058-3c75-494a-9f04-30b2554c23fd)(form(Tok \
         new_frunk))))(Tile((id \
         5273bf16-5cbb-4f53-a32b-466a938eb9ce)(form(Compound Ap))(shards(0 \
         1))(children(((Tile((id \
         1f779ffb-ff8b-4222-93bd-44bab330e1b5)(form(Tok \
         4)))))))))(Secondary((id \
         ...
         \"))))(Tile((id 6e59a58b-71af-4f27-8f95-392d13483120)(form(Tok \
         314))))(Secondary((id \
         ...
         \"))))(Tile((id 1b9e2058-2ad7-46d2-a25c-7b4ef6a29b35)(form(Tok \
         new_frunk))))(Tile((id \
         aa46a25b-672e-447b-9669-7083528e2795)(form(Compound Ap))(shards(0 \
         1))(children(((Tile((id \
         029854fa-d74b-49cd-9991-300cf6c94f0b)(form(Tok \
         6)))))))))(Secondary((id \
         ...
         \"))))(Tile((id ad4d5c78-03a9-412b-a1cb-4acf0a1abd03)(form(Tok \
         330))))(Secondary((id \
         ...
         \"))))(Tile((id 04117a05-1f56-4544-93bf-0cfcbb7d01ad)(form(Tok \
         a))(sort Pat)))(Tile((id \
         091332b3-06e8-4124-9d21-ef05a37c5383)(form(Compound TypeAsc))(sort \
         Pat)))(Secondary((id \
         1c67eb36-e4c2-4be8-a84e-2e29615d5303)(content(Whitespace\" \
         \"))))(Tile((id 617d87f4-440c-4bd5-ab86-b7faaf4686d7)(form(Tok \
         ...
         \"))))(Tile((id 8e9fce8d-ffe4-45c8-86d4-75f7fa89a8fe)(form(Tok \
         1))))(Secondary((id \
         ...
         \"))))(Tile((id 9d315d88-b98b-41b8-8e04-7ddba521bd85)(form(Tok \
         b))(sort Pat)))(Tile((id \
         df7f3d3d-e04d-4d7c-9f0f-01cc02ac3135)(form(Compound TypeAsc))(sort \
         Pat)))(Secondary((id \
         25fdf4f1-4ebf-4403-8de8-55f90220a5f9)(content(Whitespace\" \
         \"))))(Tile((id 58de8b6a-6da0-40cf-b10a-63331f94cf7d)(form(Tok \
         Bool))(sort Typ)))(Secondary((id \
         8bcc588e-40c9-47a8-be22-7e050afcd2f2)(content(Whitespace\" \
         \")))))((Secondary((id \
         0b4f53ee-5e63-443a-a274-f8b19e1942be)(content(Whitespace\" \
         \"))))(Tile((id 794364b5-110d-40d0-bee0-5715daf0560c)(form(Tok \
         true))))(Secondary((id \
         ...
         \"))))(Tile((id b2830b30-7efa-42e0-9c0f-7633d1271b07)(form(Tok \
         c))(sort Pat)))(Tile((id \
         515471c5-2637-46a4-aa13-c9620d01e087)(form(Compound TypeAsc))(sort \
         Pat)))(Secondary((id \
         ...
         132d839b-f165-44cb-aa5a-9fe8ec209389)(form(Tok String))(sort \
         Typ)))(Tile((id 95b09bc6-8873-414e-b036-36019aead9a4)(form(Compound \
         Comma))(sort Typ)))(Secondary((id \
         a1e79dfd-17f2-4a39-aa7c-70715d12c20f)(content(Whitespace\" \
         \"))))(Tile((id 5c7646e2-8d1c-42d2-8691-c5a6fcee5e20)(form(Tok \
         ...
         Parens))(shards(0 1))(children(((Tile((id \
         5837eaf2-219b-47e3-94cb-4f1a9ca40cbf)(form(Tok ?))))(Tile((id \
         49021cbc-16e2-4850-8d29-fb068ba21425)(form(Compound \
         Comma))))(Secondary((id \
         247870ad-e009-476d-a456-933d9f8eeb30)(content(Whitespace\" \
         \"))))(Tile((id 48269f5a-0157-4eb7-a92f-0192a15742e9)(form(Tok \
         1)))))))))(Secondary((id \
         0ecbef06-b1e6-4ec1-afcb-10a9b52a5b5d)(content(Whitespace\" \
         \")))))))))(Secondary((id \
         fc419efe-9b69-43d5-a8ec-2711a99cef14)(content(Whitespace\"\\n\"))))(Tile((id \
         35a67ab1-de80-4647-8ff3-35d78ece4ac1)(form(Tok b))))(Tile((id \
         464cf396-36e3-47de-b0c4-8b91c7649c59)(form(Compound \
         CellJoin))))(Secondary((id \
         ...
         \"))))(Tile((id 3c858513-2bee-46f4-8cd9-45e3e47aa293)(form(Tok \
         inventory))(sort Pat)))(Secondary((id \
         ...
         ebc745e4-b77d-4cb9-9bee-2b3304dfddeb)(form(Compound Parens))(shards(0 \
         1))(children(((Tile((id \
         ...
         52bec67a-1c60-4f6c-9210-5727d8e0bf24)(form(Compound Parens))(shards(0 \
         1))(children(((Tile((id \
         33563913-885b-438f-ad76-0c3dbb5cd595)(form(Tok item))))(Tile((id \
         147db9ee-159b-4166-a279-82a9e0813c19)(form(Compound \
         TupleLabeled))))(Tile((id \
         bf7a07d2-07da-428a-9ac1-954411f88920)(form(Tok\"\\\"Apple\\\"\"))))(Tile((id \
         ...
         \"))))(Tile((id 207d3609-346d-4961-988e-b33e9a8aa874)(form(Tok \
         qty))))(Tile((id 42312cc3-be2b-42dd-ac3d-f73b03d3e0a8)(form(Compound \
         TupleLabeled))))(Tile((id \
         01e1934d-281c-4cce-8a9e-035037ebc78b)(form(Tok 24))))(Tile((id \
         e6712cc5-57a5-4d80-8cc9-a49cf674b8f4)(form(Compound \
         Comma))))(Secondary((id \
         ab4fb133-96a4-4119-8dd1-c60a89b3833f)(content(Whitespace\" \
         \"))))(Tile((id bf6f9959-967e-4be3-bb5a-e55aaac8c77a)(form(Tok \
         price))))(Tile((id \
         19e0d7c8-733d-4766-8e4c-f805deba44b6)(form(Compound \
         TupleLabeled))))(Tile((id \
         5221b01a-4c16-493e-9a28-a96a841003e5)(form(Tok 0.50)))))))))(Tile((id \
         8bd3838c-d1d1-4f2c-958f-9ebd797c4dc7)(form(Compound \
         Comma))))(Secondary((id \
         8e941618-10ac-4e06-b5a4-e27d89d229ff)(content(Whitespace\"\\n\"))))(Tile((id \
         19bef997-5ad5-4956-8937-473a9ede8141)(form(Compound Parens))(shards(0 \
         1))(children(((Tile((id \
         ebc97349-854d-4f95-af54-73b254b82de1)(form(Tok item))))(Tile((id \
         8fdbaf21-f5b9-4a6e-bd78-b60cd2839b64)(form(Compound \
         TupleLabeled))))(Tile((id \
         6958a028-4e70-4bc7-b17a-bc2a76b865be)(form(Tok\"\\\"Bread\\\"\"))))(Tile((id \
         ...
         \"))))(Tile((id f6e18a0c-aa55-4fcc-8383-929a02bbdbc3)(form(Tok \
         qty))))(Tile((id 7034025e-1201-497c-9075-023ec61240e8)(form(Compound \
         TupleLabeled))))(Secondary((id \
         be2e7860-7ebd-4a1c-95dc-c4947b46469f)(content(Whitespace\" \
         \"))))(Tile((id fc4dbe54-53de-4775-bf04-e903d6d1a453)(form(Tok \
         8))))(Tile((id b91313b4-eb02-4b63-8e39-9e9e1fdbf265)(form(Compound \
         Comma))))(Secondary((id \
         8758f0b8-328c-4242-9263-6f752781171c)(content(Whitespace\" \
         \"))))(Tile((id fcd7ee50-691b-479d-98c1-e598993933f1)(form(Tok \
         price))))(Tile((id \
         5d1f02d3-7f9e-42f0-8e1f-0ce67412fca3)(form(Compound \
         TupleLabeled))))(Tile((id \
         f30ef914-7cc8-4b33-8b82-f557d631731d)(form(Tok 2.75)))))))))(Tile((id \
         410483c1-b56e-4bdb-ae15-19c2e2856f3a)(form(Compound \
         Comma))))(Secondary((id \
         84ee6737-c57b-4792-aa19-72d69301ba47)(content(Whitespace\"\\n\"))))(Tile((id \
         8f29d8d0-df40-489c-b929-16c55feeb85a)(form(Compound Parens))(shards(0 \
         1))(children(((Tile((id \
         0e6fabc6-ee78-4bcf-b8e2-9ee3468d6074)(form(Tok item))))(Tile((id \
         54870fc1-0150-452e-840f-bc5211bf7291)(form(Compound \
         TupleLabeled))))(Tile((id \
         36d80c1e-92c5-4217-b799-05c4f32c00d9)(form(Tok\"\\\"Cheese\\\"\"))))(Tile((id \
         8ce1e3d8-d5f0-4ee7-a3ac-6f3f578ce221)(form(Compound \
         Comma))))(Secondary((id \
         64cf943a-8f6a-4132-904f-d6cae32a50ec)(content(Whitespace\" \
         \"))))(Tile((id ec541495-01fe-4fe5-9d7e-cfe16a0a2538)(form(Tok \
         qty))))(Tile((id 1caf4064-ed70-42ea-adc2-01d9a9a2709b)(form(Compound \
         TupleLabeled))))(Secondary((id \
         82ec6add-d00e-47d7-b698-6bf7ec3f06c7)(content(Whitespace\" \
         \"))))(Tile((id 578e8e36-5e1b-4ff3-9dca-2f99d7f8027f)(form(Tok \
         3))))(Tile((id 24d0ffac-7cbe-47e4-8c9d-302d9ee105ef)(form(Compound \
         Comma))))(Secondary((id \
         dc0c7453-225a-4bf5-bda7-ee0ad03b1017)(content(Whitespace\" \
         \"))))(Tile((id 4810e706-eb3f-4c90-a584-f9497f38bade)(form(Tok \
         price))))(Tile((id \
         ee596265-2947-4d1f-8d80-e34278337258)(form(Compound \
         TupleLabeled))))(Tile((id \
         48858fb5-c32e-4933-a3e2-03571e3f6e04)(form(Tok 6.20)))))))))(Tile((id \
         645a75a4-f918-463c-bfc6-db71dc92eb9e)(form(Compound \
         Comma))))(Secondary((id \
         66187f25-98e2-4bae-8663-6b737645d012)(content(Whitespace\"\\n\"))))(Tile((id \
         6b1e0a65-0568-4856-9436-9d7a1a66932a)(form(Compound Parens))(shards(0 \
         1))(children(((Tile((id \
         cbd8e6e8-7fc7-4eb7-99c4-32faba02c0f2)(form(Tok item))))(Tile((id \
         88238aec-fe7f-4ffe-b996-933f13d05717)(form(Compound \
         TupleLabeled))))(Tile((id \
         445530b4-d5ef-4c2c-8227-00447d675bb1)(form(Tok\"\\\"Donut\\\"\"))))(Tile((id \
         ...
         \"))))(Tile((id 60bf7a57-96a5-4d30-b32b-e3e983ed5bac)(form(Tok \
         qty))))(Tile((id 801fd2da-d7ee-4ffa-91cb-cb86eeac8cfb)(form(Compound \
         TupleLabeled))))(Tile((id \
         999ead28-7ed0-4743-b7e5-b7eb938a0d43)(form(Tok 12))))(Tile((id \
         9061cc29-898d-4c6c-8919-39e8a3031a5c)(form(Compound \
         Comma))))(Secondary((id \
         7c3cfd68-f397-4607-94c7-58bd2eba9d13)(content(Whitespace\" \
         \"))))(Tile((id f2080751-a079-4d94-a767-294d084f3c6b)(form(Tok \
         price))))(Tile((id \
         28b29724-ff95-48eb-b629-40b2ed498510)(form(Compound \
         TupleLabeled))))(Tile((id \
         af18c3f0-f21c-4189-aaec-58de73d88bb8)(form(Tok 1.10)))))))))(Tile((id \
         1117d1fa-51e4-4967-913b-3fae1b91516e)(form(Compound \
         Comma))))(Secondary((id \
         9550a4b0-9c6e-4bf3-b822-8471f80f4b13)(content(Whitespace\"\\n\"))))(Tile((id \
         7cdeef31-affc-4806-abfd-8bc5af107ee2)(form(Compound Parens))(shards(0 \
         1))(children(((Tile((id \
         32f6995a-10ef-4849-88ac-c58439c2bb09)(form(Tok item))))(Tile((id \
         984374d2-b060-4c4e-9960-48f980bc5392)(form(Compound \
         TupleLabeled))))(Tile((id \
         105ab85d-0c35-41de-ad96-281766f3ad9d)(form(Tok\"\\\"Eggs\\\"\"))))(Tile((id \
         ...
         \"))))(Tile((id f545b29a-d40e-4481-b1c0-04ee7eb6cfd5)(form(Tok \
         qty))))(Tile((id 1764fb16-421c-4d28-85d3-8428eba75c89)(form(Compound \
         TupleLabeled))))(Secondary((id \
         820b8c65-8da2-439a-869f-28d959cbbf66)(content(Whitespace\" \
         \"))))(Tile((id edb67966-32c7-4788-b1f6-f7f224e4306f)(form(Tok \
         6))))(Tile((id 8c8a4ab7-f982-4b4b-92fd-b11364f6b391)(form(Compound \
         Comma))))(Secondary((id \
         3ffdf08a-aef3-4b0b-9c84-02f52b14a033)(content(Whitespace\" \
         \"))))(Tile((id 93b7690f-bb52-4ca7-a796-59d003d666a5)(form(Tok \
         price))))(Tile((id \
         35c778ce-a5b1-4ff6-bd1a-639d78c659b9)(form(Compound \
         TupleLabeled))))(Tile((id \
         32676e0f-b12b-438c-acda-cb184e25a0d5)(form(Tok \
         3.40)))))))))(Secondary((id \
         ...
         03448954-5408-4682-b6c3-7a08e40cb287)(form(Tok \

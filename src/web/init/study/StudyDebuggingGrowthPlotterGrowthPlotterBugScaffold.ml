...
(* Source: hazel-programs/study/debugging/growth-plotter/growth-plotter-bug-scaffold.hz *)

let out : string * Haz3lcore.PersistentZipper.t =
  ( "Study / debugging / growth-plotter / growth-plotter-bug-scaffold",
...
# The lifecycle is: Seed -> Sprout -> Growing -> Mature -> ReadyToHarvest #

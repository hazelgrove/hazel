...
(* Source: hazel-programs/study/debugging/companion-plotter/companion-plotter-bug.hz *)

let out : string * Haz3lcore.PersistentZipper.t =
  ( "Study / debugging / companion-plotter / companion-plotter-bug",

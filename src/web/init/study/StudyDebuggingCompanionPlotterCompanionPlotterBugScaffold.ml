...
(* Source: hazel-programs/study/debugging/companion-plotter/companion-plotter-bug-scaffold.hz *)
...
# 🌱 and 🌿 are companions (Beneficial) #
# 🍄 and ☘️ are companions (Beneficial) #
# 🌱 and 🍄 are rivals (Harmful) #
...
# Effect should be between the current cell's crop and the neighbor's crop #

...
(* Source: hazel-programs/study/debugging/soil-plotter/soil-plotter.hz *)

let out : string * Haz3lcore.PersistentZipper.t =
  ( "Study / debugging / soil-plotter / soil-plotter",
    Haz3lcore.PersistentZipper.of_slide_text
      {x|# Crop Plotter with Soil Types #
...
# Plant crop at position, preserving soil type #

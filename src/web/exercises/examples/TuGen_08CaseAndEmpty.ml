...
let exercise : Tutorial.spec = {
  id = Option.get (Haz3lcore.Id.of_string "b0000007-0007-0007-0007-000000000007");
...
Then: On a full moon the plant wants 30 ml less. Fill the hole so the watering comes to **220**.|x};
  ...
  task_reference = {x|### Sum types and case
```hazel
...
| _ => base
  ...
  hidden_tests =
    {
      tests =
        Option.get (Haz3lcore.TextRoundtrip.of_text ~root:Exp {x|test answer == 220 end|x});

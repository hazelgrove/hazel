let exercise : Tutorial.spec =
  {
    ...
    prompt =
      "Entries can be dropped from a labeled tuple with `omit_labels`.\n\n\
       ...
       ```\n\n\
       Labels are not strings, so they are delimited by backticks rather than \
       double quotes to give them stronger typing.\n\n\
    ...
    wrapper = false;
    show_report = true;
    setting_overrides = Tutorial.no_setting_overrides;
  }

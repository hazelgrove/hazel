...
(* Source: hazel-programs/tutorial/archive/06-probes.hz *)

let exercise : Tutorial.spec = {
  id = Option.get (Haz3lcore.Id.of_string "a0000020-0020-0020-0020-000000000020");
  title = "Archive / 06 - Probes";
  version = 1;
  module_name = "TuGen_Archive06Probes";
...
Try **Shift+click and drag** on the probe sample to resize it and see the full value.|x};
  display_hint = {x|Right-click an expression and select "Add probe",
or place your cursor on it and press Cmd+E / Ctrl+E|x};
  task_reference = {x|### Adding a Probe

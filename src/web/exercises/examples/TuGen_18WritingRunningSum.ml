...
let exercise : Tutorial.spec = {
  id = Option.get (Haz3lcore.Id.of_string "b0000018-0018-0018-0018-000000000018");
  title = "18 - Writing Running Sum";
  version = 1;
  module_name = "TuGen_18WritingRunningSum";
  prompt = {x|Now write one yourself, with auto-probe on so you can watch it run.
...
nightly_totals([250, 180, 50])|x}));
  hidden_tests =
    {
      tests =
        Option.get (Haz3lcore.TextRoundtrip.of_text ~root:Exp {x|test nightly_totals([250, 180, 50]) == [250, 430, 480] end;

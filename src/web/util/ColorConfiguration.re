...
let aliases: list(((string, string), list(string))) = [
  ...
  (("chrome", "debug-bar"), ["debug-bar-bkg"]),
  (("chrome", "debug-field"), ["debug-field-bkg"]),
  ...
  (("problems", "error-row"), ["problem-error-row"]),
  (("problems", "error-row-edge"), ["problem-error-row-edge"]),
  (("problems", "syntax-row"), ["problem-syntax-row"]),
  (("problems", "syntax-row-active"), ["problem-syntax-row-active"]),
  (("problems", "syntax-row-edge"), ["problem-syntax-row-edge"]),
  (("problems", "hole-row"), ["problem-hole-row"]),
  (("problems", "hole-row-active"), ["problem-hole-row-active"]),
  (("problems", "hole-row-edge"), ["problem-hole-row-edge"]),
  (("problems", "warning-row"), ["problem-warning-row"]),
  (("problems", "warning-row-active"), ["problem-warning-row-active"]),
  (("problems", "warning-row-edge"), ["problem-warning-row-edge"]),
  (("problems", "nav-hover"), ["problem-nav-hover"]),
  (("results", "reused-glow"), ["incremental-frozen-glow"]),
  (("agent", "active-task"), ["agent-active-task"]),
  (("agent", "active-task-hover"), ["agent-active-task-hover"]),
  (("agent", "active-task-edge"), ["agent-active-task-edge"]),
  (("agent", "active-task-edge-hover"), ["agent-active-task-edge-hover"]),
  (("agent", "active-subtask"), ["agent-active-subtask"]),
  (("agent", "active-subtask-hover"), ["agent-active-subtask-hover"]),
  (("agent", "active-step"), ["agent-active-step"]),

let exercise : DerivationTree.spec =
  {
    id =
      Option.get (Haz3lcore.Id.of_string "6877c1e5-4421-40c8-9da3-9b41f3e48a3d");
                            ...
                            Tile
                              {
                                id =
                                  Option.get
                                    (Haz3lcore.Id.of_string
                                       "56c51887-b5c1-4bf3-92ab-73503b857994");
                                label = [ "$" ];
                                mold =
                                  {
                                    out = Pat;
                                ...
                                Tile
                                  {
                                    id =
                                      Option.get
                                        (Haz3lcore.Id.of_string
                                           "e872ac2b-364d-46f3-b73a-5f671bf4ec34");
                                    label = [ "$" ];
                                    mold =
                                      {
                                        out = Pat;
                                                ...
                                                Tile
                                                  {
                                                    id =
                                                      Option.get
                                                        (Haz3lcore.Id.of_string
                                                           "dfd88a2e-c8f4-4579-8bd2-f2bdcb43eb91");
                                                    label = [ "$" ];
                                                    mold =
                                                      {
                                                        out = Drv Exp;
                                                ...
                                                Tile
                                                  {
                                                    id =
                                                      Option.get
                                                        (Haz3lcore.Id.of_string
                                                           "a6808e1b-1a62-43af-88e7-ef5fbda11f61");
                                                    label = [ "("; ")" ];
                                                    mold =
                                                      {
                                                        out = Drv Exp;

let exercise : DerivationTree.spec =
  {
    id =
      Option.get (Haz3lcore.Id.of_string "280ed584-a895-40ee-8292-8622b0aab321");
                  ...
                  Secondary
                    {
                      id =
                        Option.get
                          (Haz3lcore.Id.of_string
                             "41e1c1b0-8e1f-4379-8ff7-7d42f3a5389c");
                      content = Whitespace "\n";
                    };
                ],
                [
                            ...
                            Tile
                              {
                                id =
                                  Option.get
                                    (Haz3lcore.Id.of_string
                                       "2221d40a-a814-4cd1-89b5-200aa424408c");
                                label = [ "$" ];
                                mold =
                                  {
                                    out = Pat;
                                ...
                                Tile
                                  {
                                    id =
                                      Option.get
                                        (Haz3lcore.Id.of_string
                                           "792c6246-602d-4afb-b6f4-1d1badf1284a");
                                    label = [ "$" ];
                                    mold =
                                      {
                                        out = Pat;
                                          ...
                                          Tile
                                            {
                                              id =
                                                Option.get
                                                  (Haz3lcore.Id.of_string
                                                     "b541be9f-4df1-471e-9194-1f989cc24f08");
                                              label = [ "$" ];
                                              mold =
                                                {
                                                  out = Drv Exp;
                                ...
                                Tile
                                  {
                                    id =
                                      Option.get
                                        (Haz3lcore.Id.of_string
                                           "21e30f4f-7b06-46e3-88cf-31104a0e59f8");
                                    label = [ "$" ];
                                    mold =
                                      {
                                        out = Pat;
                                          ...
                                          Tile
                                            {
                                              id =
                                                Option.get
                                                  (Haz3lcore.Id.of_string
                                                     "28b2fab7-44a7-4663-ae0c-6aac63367025");
                                              label = [ "$" ];
                                              mold =
                                                {
                                                  out = Drv Exp;
                              ...
                              Tile
                                {
                                  id =
                                    Option.get
                                      (Haz3lcore.Id.of_string
                                         "1acdbc55-6fc7-4d19-8f44-8d706f628c6a");
                                  label = [ "$" ];
                                  mold =
                                    {
                                      out = Drv Exp;

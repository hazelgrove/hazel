let exercise : DerivationTree.spec =
  {
    id =
      Option.get (Haz3lcore.Id.of_string "338e2b2a-3dbe-4b01-9e7e-9616f825931d");
    title = "Task 3 of 7: Debugging";
    module_name = "t3";
    prompt =
                  ...
                  Tile
                    {
                      id =
                        Option.get
                          (Haz3lcore.Id.of_string
                             "1fecf352-b431-4d92-82db-41494e74df8d");
                      label = [ "$" ];
                      mold =
                        {
                          out = Pat;
                                ...
                                Tile
                                  {
                                    id =
                                      Option.get
                                        (Haz3lcore.Id.of_string
                                           "b9746494-9347-4892-85b6-38a20e71022c");
                                    label = [ "$" ];
                                    mold =
                                      {
                                        out = Pat;
                              ...
                              Tile
                                {
                                  id =
                                    Option.get
                                      (Haz3lcore.Id.of_string
                                         "fcf98e8a-1d71-4a93-8018-41baaf501425");
                                  label = [ "$" ];
                                  mold =
                                    {
                                      out = Drv Exp;
                              ...
                              Tile
                                {
                                  id =
                                    Option.get
                                      (Haz3lcore.Id.of_string
                                         "d66f09d5-40ed-4fa4-ba24-2c3ec25c3c1c");
                                  label = [ "gamma_ab" ];
                                  mold =
                                    {
                                      out = Drv Exp;
                              ...
                              Tile
                                {
                                  id =
                                    Option.get
                                      (Haz3lcore.Id.of_string
                                         "3fdf7752-bc1d-43da-a73a-a20552d244c4");
                                  label = [ "$" ];
                                  mold =
                                    {
                                      out = Drv Exp;
                              ...
                              Tile
                                {
                                  id =
                                    Option.get
                                      (Haz3lcore.Id.of_string
                                         "1c65136a-6b17-4db6-abc8-74f503338c79");
                                  label = [ "gamma_ab" ];
                                  mold =
                                    {
                                      out = Drv Exp;
                                        ...
                                        Tile
                                          {
                                            id =
                                              Option.get
                                                (Haz3lcore.Id.of_string
                                                   "833466a3-675d-4df0-b927-046c0e71ecc6");
                                            label = [ "$" ];
                                            mold =
                                              {
                                                out = Drv Exp;
                                        ...
                                        Tile
                                          {
                                            id =
                                              Option.get
                                                (Haz3lcore.Id.of_string
                                                   "443e0695-7f45-4d23-a65f-c721350b575f");
                                            label = [ "gamma_a" ];
                                            mold =
                                              {
                                                out = Drv Exp;
                                        ...
                                        Tile
                                          {
                                            id =
                                              Option.get
                                                (Haz3lcore.Id.of_string
                                                   "44cb561f-1774-4dc4-a7bf-18343c9b9a40");
                                            label = [ "|-" ];
                                            mold =
                                              {
                                                out = Drv Exp;
                                          ...
                                          Tile
                                            {
                                              id =
                                                Option.get
                                                  (Haz3lcore.Id.of_string
                                                     "94e53479-1339-42c8-94a0-fa29b606db1d");
                                              label = [ "$" ];
                                              mold =
                                                {
                                                  out = Drv Exp;
                                          ...
                                          Tile
                                            {
                                              id =
                                                Option.get
                                                  (Haz3lcore.Id.of_string
                                                     "cf0926be-9209-4e26-a5f0-8aae64850106");
                                              label = [ "gamma_ab" ];
                                              mold =
                                                {
                                                  out = Drv Exp;

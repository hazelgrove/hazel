let exercise : DerivationTree.spec =
  {
    id =
      Option.get (Haz3lcore.Id.of_string "409f23b1-93e7-48e9-94b3-aed9810a06b2");
                              ...
                              Tile
                                {
                                  id =
                                    Option.get
                                      (Haz3lcore.Id.of_string
                                         "c3e12848-d135-4211-81b0-65a0a933261b");
                                  label = [ "("; ")" ];
                                  mold =
                                    {
                                      out = Drv Exp;
                                        ...
                                        Tile
                                          {
                                            id =
                                              Option.get
                                                (Haz3lcore.Id.of_string
                                                   "d9ea329c-b6c6-4d78-bf5e-5e634273eabf");
                                            label = [ "1" ];
                                            mold =
                                              {
                                                out = Drv Exp;
                              ...
                              Tile
                                {
                                  id =
                                    Option.get
                                      (Haz3lcore.Id.of_string
                                         "38917193-0934-4213-8a74-301c1729e4f1");
                                  label = [ "2" ];
                                  mold =
                                    {
                                      out = Drv Exp;

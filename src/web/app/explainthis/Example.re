...
let mk_parens_exp = mk_tile(Form.get(ParensExp), _);
let mk_parens_pat = mk_tile(Form.get(ParensPat), _);
let mk_parens_typ = mk_tile(Form.get(ParensTyp), _);
let mk_list_exp = mk_tile(Form.get(ListLitExp), _);
let mk_list_pat = mk_tile(Form.get(ListLitPat), _);
let mk_list_typ = mk_tile(Form.get(ListTyp), _);
let mk_forall = mk_tile(Form.get(Forall), _);
let mk_rec = mk_tile(Form.get(Rec), _);
...
let mk_typfun = mk_tile(Form.get(TypFun), _);
let mk_fun = mk_tile(Form.get(Fun), _);
let mk_ap_exp_typ = mk_tile(Form.get(ApExpTyp), _);
let mk_fix = mk_tile(Form.get(Fix), _);
let mk_ap_exp = mk_tile(Form.get(ApExp), _);
let mk_ap_pat = mk_tile(Form.get(ApPat), _);
let mk_let = mk_tile(Form.get(Let), _);
let mk_use = mk_tile(Form.get(Use), _);
let mk_tyalias = mk_tile(Form.get(TypeAlias), _);
let mk_if = mk_tile(Form.get(If), _);
let mk_test = mk_tile(Form.get(Test), _);
let mk_hinted_test = mk_tile(Form.get(HintedTest), _);
let mk_case = mk_tile(Form.get(Case), _);
let mk_rule = mk_tile(Form.get(Rule), _);
let mk_hide = mk_tile(Form.get(FilterHide), _);
let mk_eval = mk_tile(Form.get(FilterEval), _);
let mk_pause = mk_tile(Form.get(FilterPause), _);
let mk_debug = mk_tile(Form.get(FilterDebug), _);
let mk_unquote = mk_tile(Form.get(Unquote), _);

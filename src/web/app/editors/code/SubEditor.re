 ...
 * the caret's representative piece (left-preferred), which at the
 * splice's first position is the whitespace outside the splice — fall
 * back to the in-splice neighbor's edge there. */

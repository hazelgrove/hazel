...
and parse_adt = x =>
  ...
  | _ =>
    failwith(
      "Some code generated by parser_generator.py is throwing a parse error:\nWhile parsing a/an adt, I got \""
      ++ implode(x)
      ++ "\" which doesn't match any of the expected tags: ['l', 'n', 'b']",
    )
  }
and parse_res = x =>
  switch (x) {
  ...
  | _ =>
    failwith(
      "Some code generated by parser_generator.py is throwing a parse error:\nWhile parsing a/an res, I got \""
      ++ implode(x)
      ++ "\" which doesn't match any of the expected tags: ['float', 'ictor', 'ctor', 'case', 'fst', 'i', 'b', 'c', 'n', 'f', 'a', 'h', 'u', 'p', 's']",
    )
  }
and parse_ann = x =>
  switch (x) {
  ...
  | _ =>
    failwith(
      "Some code generated by parser_generator.py is throwing a parse error:\nWhile parsing a/an ann, I got \""
      ++ implode(x)
      ++ "\" which doesn't match any of the expected tags: ['a', 'a', 'a', 'a']",
    )
  }
and parse_value = x =>
  switch (x) {
  ...
  | _ =>
    failwith(
      "Some code generated by parser_generator.py is throwing a parse error:\nWhile parsing a/an value, I got \""
      ++ implode(x)
      ++ "\" which doesn't match any of the expected tags: ['i', 'b', 'u', 'p', 'c']",
    )
  }
and parse_debug_construct = x =>
  ...
  | _ =>
    failwith(
      "Some code generated by parser_generator.py is throwing a parse error:\nWhile parsing a/an debug_construct, I got \""
      ++ implode(x)
      ++ "\" which doesn't match any of the expected tags: ['constraint', 'unevalcons', 'excons', 'env', 'ex', 'hc', 'hf', 'hi', 'e', 'r', 't', 'c', 'd', 'g', 's', 'f', 'u', 'b']",
    )
  }
and parse_type_ = x =>
  switch (x) {
  ...
  | _ =>
    failwith(
      "Some code generated by parser_generator.py is throwing a parse error:\nWhile parsing a/an type_, I got \""
      ++ implode(x)
      ++ "\" which doesn't match any of the expected tags: ['fail', 'i', 'b', 'c', 'f', 'u', 'p', 'a', 'd']",
    )
  }
and parse_exp = x =>
  switch (x) {
  ...
  | _ =>
    failwith(
      "Some code generated by parser_generator.py is throwing a parse error:\nWhile parsing a/an exp, I got \""
      ++ implode(x)
      ++ "\" which doesn't match any of the expected tags: ['float', 'ctor', 'case', 'fst', 'i', 'b', 'c', 'n', 'f', 'a', 'h', 'u', 'v', 'p', 's']",
    )
  }
and parse_pattern = x =>
  switch (x) {
  ...
  | _ =>
    failwith(
      "Some code generated by parser_generator.py is throwing a parse error:\nWhile parsing a/an pattern, I got \""
      ++ implode(x)
      ++ "\" which doesn't match any of the expected tags: ['v', 'p']",
    )
  }
and parse_example = x =>
  switch (x) {
  ...
  | _ =>
    failwith(
      "Some code generated by parser_generator.py is throwing a parse error:\nWhile parsing a/an example, I got \""
      ++ implode(x)
      ++ "\" which doesn't match any of the expected tags: ['t', 'u', 'i', 'b', 'p', 'f', 'c']",
    )
  }
and parse_int = x => {

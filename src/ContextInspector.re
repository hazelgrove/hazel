...
let mk
  ...
  module M = {
    ...
    let dynamic_info sigma x =>
      ...
      | Some d =>
        let dhexp_html =
          View.html_of_dhexp instance_click_fn dhexp_width ("context-" ^ x) d;
        Some Html5.(
               div
                 a::[a_class ["dynamic-info"]]
        ...
        span
          ...
          [
            span
              a::[a_class ["inst"]]
              [
                View.html_of_hole_instance instance_click_fn 80 "path-view" inst
              ],
    ...
    let path_view inst (path: Dynamics.DHExp.InstancePath.t) => {
      let (titlebar_txt, path_area_children) =
        ...
        | [] => (
            ...
            [
              Html5.(
                div a::[a_class ["special-msg"]] [div [pcdata "immediately"]]
              )
            ]
          )
        | _ =>
                  ...
                  div
                    ...
                    [
                      View.html_of_hole_instance
                        instance_click_fn 80 "path-view" inst
                    ]
                )
              ]
              path;
    ...
    let hii_summary
            ...
            [
              div [
                div
                  ...
                  [
                    View.html_of_hole_instance
                      instance_click_fn 80 "hii-summary" inst
                  ],
                pcdata " = hole ",
                span
      ...
      let prev_btn =
        ...
        | None =>
          ...
          Html5.(
            div
              a::[a_class prev_cls, a_title prev_title] [pcdata "\226\151\130"]
          )
        };
      let next_btn =
        switch next_state {
        ...
        | None =>
          ...
          Html5.(
            div
              a::[a_class next_cls, a_title next_title] [pcdata "\226\150\184"]
          )
        };
      let controls =

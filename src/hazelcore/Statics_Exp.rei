...
let syn_nth_type_mode:
  (Contexts.t, MetaVarGen.t, int, UHExp.opseq) =>
 ...
 */
let syn:
  (Contexts.t, MetaVarGen.t, UHExp.t) => option((HTyp.t, MetaVarGen.t));
let syn_block:
  (Contexts.t, MetaVarGen.t, UHExp.block) => option((HTyp.t, MetaVarGen.t));
let syn_lines:
  (Contexts.t, MetaVarGen.t, list(UHExp.line)) =>
  option((Contexts.t, MetaVarGen.t));
let syn_opseq:
  (Contexts.t, MetaVarGen.t, UHExp.opseq) => option((HTyp.t, MetaVarGen.t));
let syn_skel:
  (Contexts.t, MetaVarGen.t, UHExp.skel, UHExp.seq) =>
  option((HTyp.t, MetaVarGen.t));
let syn_operand:
  (Contexts.t, MetaVarGen.t, UHExp.operand) => option((HTyp.t, MetaVarGen.t));
let syn_rules:
  (Contexts.t, MetaVarGen.t, UHExp.rules, HTyp.t) =>
  option((HTyp.t, MetaVarGen.t));
let syn_rule:
  (Contexts.t, MetaVarGen.t, UHExp.rule, HTyp.t) =>
  option((HTyp.t, MetaVarGen.t));
...
let joined_pattern_type:
  (Contexts.t, MetaVarGen.t, list(UHExp.rule)) =>
  option((HTyp.t, MetaVarGen.t));

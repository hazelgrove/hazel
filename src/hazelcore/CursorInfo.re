...
and extract_from_zexp_operand = (zexp_operand: ZExp.zoperand): cursor_term => {
  ...
  | SubscriptZE1(_, zexp, _, _) => extract_cursor_exp_term(zexp)
  | SubscriptZE2(_, _, zexp, _) => extract_cursor_exp_term(zexp)
  | SubscriptZE3(_, _, _, zexp) => extract_cursor_exp_term(zexp)
  };
}
...
module Exp = {
  ...
  and ana_cursor_info_zoperand =
    ...
    | SubscriptZE3(InHole(WrongLength, _), _, _, _) => None

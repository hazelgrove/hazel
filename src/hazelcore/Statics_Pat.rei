...
let syn_nth_type_mode:
  (Contexts.t, MetaVarGen.t, int, UHPat.opseq) => option(Statics.type_mode);
/**
 ...
 */
let syn: (Contexts.t, MetaVarGen.t, UHPat.t) => option((HTyp.t, Contexts.t));
let syn_opseq:
  (Contexts.t, MetaVarGen.t, UHPat.opseq) => option((HTyp.t, Contexts.t));
let syn_skel:
  (Contexts.t, MetaVarGen.t, UHPat.skel, UHPat.seq) =>
  option((HTyp.t, Contexts.t));
let syn_operand:
  (Contexts.t, MetaVarGen.t, UHPat.operand) => option((HTyp.t, Contexts.t));
 ...
 */
let ana: (Contexts.t, MetaVarGen.t, UHPat.t, HTyp.t) => option(Contexts.t);
let ana_operand:
  (Contexts.t, MetaVarGen.t, UHPat.operand, HTyp.t) => option(Contexts.t);
let ana_skel:

...
and syn_perform_opseq =
  ...
  | (
    ...
    | Succeeded(SynDone((new_zexp, _, u_gen))) =>
      let (zexp, u_gen) = resurround_z(u_gen, new_zexp, surround);
...
and syn_perform_operand =
  ...
  | (
    ...
    syn_perform_operand(ctx, a, (zinj, ty, u_gen));
...
and ana_perform_opseq =
  ...
  | (
    ...
    | Succeeded(AnaDone((new_zexp, u_gen))) =>
      let (zexp, u_gen) = resurround_z(u_gen, new_zexp, surround);
...
and ana_perform_operand =
  ...
  | (
    ...
    ana_perform_operand(ctx, a, (ze, u_gen), ty);

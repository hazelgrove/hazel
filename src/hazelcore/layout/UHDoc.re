...
module Delim = {
  ...
  let open_StringLit = () => mk(~index=0, "\"");
  let close_StringLit = () => mk(~index=1, "\"");
...
module Pat = {
  ...
  let mk_StringLit = mk_StringLit(~sort=Pat);
...
module Exp = {
  ...
  let mk_StringLit = mk_StringLit(~sort=Exp);

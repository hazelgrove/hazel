...
/**
   [to_string s] converts the unescaped string [s] to a regular string.
 */
let to_string: t => string;

/**
  [from_string_unchecked s] converts the string [s] to an unescaped string
  without parsing.
 */
...
/**
   ...
   [subscript_error].
 */
let subscript: (t, int, int) => result(t, subscript_error);

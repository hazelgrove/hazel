  ...
  ( "B2T2 / Table API / Constructors / emptyTable",
    {
      segment =
        "((Tile((id ae87bbc5-a815-4105-afe6-792aade0d1d0)(label(let = \
         ...
         8b476200-1e36-4e59-9447-aaead25fd83d)(label(enforced))(mold((out \
         Exp)(in_())(nibs(((shape Convex)(sort Exp))((shape Convex)(sort \
         ...
         \"))))(Tile((id \
         1686d69a-484e-441b-b951-74b72dc62a05)(label(\"\\\"schema(t) is equal \
         ...
         Exp)(in_())(nibs(((shape Convex)(sort Exp))((shape Convex)(sort \
         Exp))))))(shards(0))(children())))(Tile((id \
         91046987-eea2-42f4-9d99-b325f396569f)(label(\"(\"\")\"))(mold((out \

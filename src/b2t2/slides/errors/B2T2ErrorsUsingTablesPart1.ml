  ...
  ( "B2T2 / Errors / Using Tables / Part 1",
    {
      segment =
        "((Tile((id 62113b4c-0c40-4a45-b224-1dc986d93454)(label(type = \
         ...
         Fold)(syntax((Tile((id 9963d03f-e703-4278-99ee-2ac8dc021884)(label([ \
         ...
         Fold)(syntax((Tile((id 0fa84c8b-1e24-4c77-a142-005992e66a2d)(label([ \
         ]))(mold((out Exp)(in_(Exp))(nibs(((shape Convex)(sort Exp))((shape \
         Convex)(sort Exp))))))(shards(0 1))(children(((Secondary((id \
         ...
         Fold)(syntax((Tile((id edd098ac-997f-45a8-9a2f-6ce12046e3d9)(label([ \
         ]))(mold((out Exp)(in_(Exp))(nibs(((shape Convex)(sort Exp))((shape \
         Convex)(sort Exp))))))(shards(0 1))(children(((Secondary((id \

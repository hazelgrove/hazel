...
let current_horizontal_shift_target_top_id = "current_horizontal_shift_target_top";
let current_horizontal_shift_target_bottom_id = "current_horizontal_shift_target_bottom";

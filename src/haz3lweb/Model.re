...
//     (Scratch(idx, slides |> List.map(CellEditor.mk)), results);
//   | Documentation =>
...
//       Documentation(
//         name,
//         slides |> List.map(((x, y)) => (x, CellEditor.mk(y))),
//       ),
//       results,
//     );
//   | Exercises =>
...
//     Store.Scratch.save((
//       n,
//       slides |> List.map(CellEditor.to_persistent),
//       results,
//     ))
//   | Documentation(name, slides) =>
//     Store.Documentation.save((
//       name,
//       slides |> List.map(((x, y)) => (x, y |> CellEditor.to_persistent)),
//       results,
//     ))
...
//   let statics = Editors.Update.mk_statics(~settings, editors);

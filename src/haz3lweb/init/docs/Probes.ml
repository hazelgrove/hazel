let out : Haz3lcore.PersistentZipper.t =
  {
    zipper =
      "((selection((focus Left)(content())(mode \
       ...
       387be71a-16af-4b31-8189-131939a90ac4)(content(Comment\"# |  ___/ '__/ _ \
       \\\\| '_ \\\\ / _ \\\\/ __| #\"))))(Secondary((id \
       ...
       8add24f1-6382-4cba-a9c9-33d7f8bb438d)(content(Comment\"# see a list of \
       all values taken on by that expression/pattern. #\"))))(Secondary((id \
       ...
       ce0c7084-5194-4e39-ac56-87ee80820c50)(content(Comment\"# including the \
       top stack frame / closure and hence the #\"))))(Secondary((id \
       ...
       07e701a1-3c36-469b-87e4-b1f71efe5de3)(content(Comment\"# as well as the \
       surrounding call stack context. #\"))))(Secondary((id \
       b479d5ba-f593-47f0-ad9c-5a7ec380e55d)(content(Whitespace\"\\n\"))))(Secondary((id \
       08c34128-af19-4856-bbd6-871103a49d20)(content(Whitespace\"\\n\"))))(Secondary((id \
       96dbf841-dd3d-49d2-b2cd-3bad24c7e801)(content(Comment\"# When a cell is \
       selected, you can hover over it to see #\"))))(Secondary((id \
       ...
       d8063084-2e49-4315-89c7-53507ebacbdc)(content(Comment\"# are decorated \
       according to their relative position in #\"))))(Secondary((id \
       ...
       supporting feature to help maintain context when #\"))))(Secondary((id \
       ...
       many values across nested or recursive functions. #\"))))(Secondary((id \
       ...
       017d0a58-fbfd-4685-ba5f-b6fe3c986730)(content(Comment\"# The expression \
       (10 * 10) below has a probe.  #\"))))(Secondary((id \
       91bbf605-8627-4521-8bd8-5775169ef465)(content(Whitespace\"\\n\"))))(Secondary((id \
       bdb51bb1-22c9-4f8f-a0a4-1ce16dfb950a)(content(Comment\"# Its value, 20, \
       is shown in a cell to the right. #\"))))(Secondary((id \
       ...
       71453117-1176-456c-8a2a-fc70edcb596d)(content(Comment\"# The expression \
       should be encased in a green block #\"))))(Secondary((id \
       ...
       efe380cc-3e63-4e01-9d79-e652d99f7e5b)(content(Comment\"# the number of \
       times the expression was evaluated #\"))))(Secondary((id \
       e2d549d8-27a9-4389-a8c4-83cf86501f97)(content(Whitespace\"\\n\"))))(Secondary((id \
       bad2cdd0-0ab5-4a9a-8cf0-f829f8f51c87)(content(Whitespace\"\\n\"))))(Secondary((id \
       574e41cb-bab4-4485-a522-4a5a1fd94a49)(content(Comment\"# Probes can be \
       placed on expressions: #\"))))(Secondary((id \
       ...
       5260e70f-f31e-4b0b-a857-f2627e638508)(content(Comment\"# have multiple \
       cells. Note the closure counts below #\"))))(Secondary((id \
       ...
       highlights cells below corresponding to the same #\"))))(Secondary((id \
       eec20346-3c6d-4650-924b-9596b6b5ec1f)(content(Whitespace\"\\n\"))))(Secondary((id \
       47acc666-1cc6-4c44-9226-f11b4bacb48f)(content(Comment\"# function call: \
       the cells reading 40.5 and 22.5) #\"))))(Secondary((id \
       ...
       Exp)(in_(Exp))(nibs(((shape(Concave 22))(sort Exp))((shape Convex)(sort \
       Exp))))))(shards(0 1))(children(((Tile((id \
       ...
       e5d5edc9-c7c7-403c-9567-8f1f07850964)(content(Comment\"# Now select the \
       cell above reading 22.5 #\"))))(Secondary((id \
       ...
       1b1080c9-efcd-415f-b107-98c840940bbf)(content(Comment\"# Note the 72.5, \
       40.5, and 22.5 are no longer green-highlit #\"))))(Secondary((id \
       ...
       8452a89c-baf2-43c7-bd9c-f9d4d2ee2cd9)(content(Comment\"# `celsius(t1)`. \
       However, they now have purple hats, indicating #\"))))(Secondary((id \
       79d88078-d8eb-44d2-852e-c22d8b806ec0)(content(Whitespace\"\\n\"))))(Secondary((id \
       48bd7065-46ee-4754-bd3f-d02cb99ee815)(content(Comment\"# they are below \
       that function call in the call stack #\"))))(Secondary((id \
       ...
       Exp)(in_(Pat))(nibs(((shape Convex)(sort Exp))((shape(Concave 35))(sort \
       Exp))))))(shards(0 1))(children(((Secondary((id \
       ...
       1f6924e3-0d13-4e40-9b78-49dfbed4d0a6)(content(Comment\"# Note how each \
       activate exactly one branch below: #\"))))(Secondary((id \
       ...
       28ec8945-9875-40c4-a9ce-36f40458998a)(content(Comment\"# Select the `5` \
       above and then the `false` below: #\"))))(Secondary((id \
       ...
       d987ed80-8af2-4ac9-8fba-0dec9383ae5c)(content(Comment\"# Note the same \
       things are highlit as both cells are #\"))))(Secondary((id \
       e0bc874c-115c-4790-a819-9448f975d80a)(content(Whitespace\"\\n\"))))(Secondary((id \
       55cf7952-2ebd-4666-a5cd-f0ba1dc5b443)(content(Comment\"# from the same \
       call to cases#\"))))(Secondary((id \
       ...
       25615a61-e624-4490-b5e0-50b20b900e3a)(content(Comment\"# Select `true` \
       below and then the `4` cell #\"))))(Secondary((id \
       ...
       962248c8-19f1-455f-a421-8c954698d404)(content(Comment\"# of indication \
       changes. The `true` below the `4` above #\"))))(Secondary((id \
       ...
       \"))))(Secondary((id \
       502f7709-6ed7-41e6-b074-659edd93570f)(content(Comment\"# above the `9` \
       cell in the function call stack. #\"))))(Secondary((id \
       ...
       \"))))(Secondary((id \
       0ffde64a-b61c-44c4-b01f-0eb36b8567a8)(content(Comment\"# For example 32 \
       below represents the call producing `9`.  #\"))))(Secondary((id \
       ...
       \"))))(Secondary((id \
       99c76088-1180-4c25-9d85-1c29d6892f01)(content(Comment\"# Note that `9` \
       and `32` both have hats. `9` has a taller hat #\"))))(Secondary((id \
       ...
       \"))))(Secondary((id \
       94feed4a-dafa-4afb-848c-d4e1216ecc28)(content(Comment\"# Now select 12 \
       below, representing a call to `second` #\"))))(Secondary((id \
       ...
       \"))))(Secondary((id \
       aabf716d-bb7d-42eb-8787-88173c1f84bb)(content(Comment\"# and then again \
       select 12, 10, 32, and 9 in turn. Notice how #\"))))(Secondary((id \
       ...
       8bf6ca27-9c76-46eb-a65d-3a649fbd3bfc)(content(Comment\"# Note how cells \
       are lowered/raised to indicate their #\"))))(Secondary((id \
       9528eb1c-c58e-4b7f-a5c6-0f5cd28566c6)(content(Whitespace\"\\n\"))))(Secondary((id \
       39bacb07-a182-4aab-8d80-913b794e1a6f)(content(Comment\"# relative call \
       stack depth to the selected cell #\"))))(Secondary((id \
       ...
       fe5a5e55-92f8-4acf-8de2-dfbad3e96aad)(content(Comment\"# TAIL RECURSION \
       #\"))))(Secondary((id \
       ...
       c49d7de4-825d-4ca7-8a03-7c85b8266424)(content(Comment\"# This is a play \
       area to explore nested function definitions #\"))))(Secondary((id \
       1a4f54f9-9a6c-4a75-ae30-b950844943c3)(content(Whitespace\"\\n\"))))(Secondary((id \
       d0c95f5c-263e-4ffa-bce2-b965ff90808e)(content(Comment\"# and functions \
       returning functions #\"))))(Secondary((id \
       ...
       a6ed225f-492e-4106-8d44-7ef5dcb49889)(content(Comment\"# fib(4-2) which \
       contains the above `1`. The `1` below #\"))))(Secondary((id \
       ...
       cdbe94f7-d280-43b3-a524-8bc14e947e6c)(content(Comment\"# the call below \
       had that value. The two `1s` outline in #\"))))(Secondary((id \
       ...
       7d7f7d80-1397-4011-9f36-3ef3c407df21)(content(Comment\"# was evaluated \
       in. #\"))))(Secondary((id \

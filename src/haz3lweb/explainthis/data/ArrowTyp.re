...
let arrow_typ: form = {
  let explanation = "Arrow type. This arrow type classifies functions with [*argument type*](%i) and [*output type*](%i).";
  {
    id: ArrowTyp,
...
let arrow3_typ: form = {
  let explanation = "Arrow type. This arrow type classifies functions with [*first argument type*](%i), [*second argument type*](%i), and [*output type*](%i).";
  let arrow2 = arrow();
  {
    id: Arrow3Typ,
    syntactic_form: [

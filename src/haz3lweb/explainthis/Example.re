...
let labeled_exp = () => mk_monotile(Form.get("tuple_labeled_exp"));
let labeled_pat = () => mk_monotile(Form.get("tuple_labeled_pat"));
let labeled_typ = () => mk_monotile(Form.get("tuple_labeled_typ"));
let dot_exp = () => mk_monotile(Form.get("dot_exp"));

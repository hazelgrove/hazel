...
let label_exp = () => mk_monotile(Form.get("tuple_label_exp"));
let label_pat = () => mk_monotile(Form.get("tuple_label_pat"));
let label_typ = () => mk_monotile(Form.get("tuple_label_typ"));

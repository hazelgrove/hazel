            ...
            ( 6954,
              {
                zipper =
                  "((selection((focus \
                   ...
                   1291)(label(Boo))(mold((out Typ)(in_())(nibs(((shape \
                   Convex)(sort Typ))((shape Convex)(sort \
                   Typ))))))(shards(0))(children())))(Secondary((id \
                   ...
                   Typ))))))(shards(0))(children())))(Secondary((id \
                   1670)(content(Whitespace\" \"))))(Tile((id \
                   1734)(label(Boo))(mold((out Typ)(in_())(nibs(((shape \
                   Convex)(sort Typ))((shape Convex)(sort \
                   Typ))))))(shards(0))(children())))(Secondary((id \
                   1674)(content(Whitespace\" \")))))))))(Secondary((id \
                   ...
                   2091)(label(Boo))(mold((out Typ)(in_())(nibs(((shape \
                   Convex)(sort Typ))((shape Convex)(sort \
                   Typ))))))(shards(0))(children())))(Secondary((id \
                   ...
                   2668)(label(Boo))(mold((out Typ)(in_())(nibs(((shape \
                   Convex)(sort Typ))((shape Convex)(sort \
                   Typ))))))(shards(0))(children())))(Secondary((id \
                   ...
                   5530)(label(In))(mold((out Typ)(in_())(nibs(((shape \
                   Convex)(sort Typ))((shape Convex)(sort \
                   Typ))))))(shards(0))(children())))(Tile((id \
                   ...
                   Typ)(in_(Typ))(nibs(((shape Convex)(sort Typ))((shape \
                   Convex)(sort Typ))))))(shards(0 1))(children(((Tile((id \
                   6621)(label(In))(mold((out Typ)(in_())(nibs(((shape \
                   Convex)(sort Typ))((shape Convex)(sort \
                   Typ))))))(shards(0))(children())))(Tile((id \
                   ...
                   5769)(label(In))(mold((out Typ)(in_())(nibs(((shape \
                   Convex)(sort Typ))((shape Convex)(sort \
                   Typ))))))(shards(0))(children())))(Tile((id \
                   ...
                   Typ)(in_(Typ))(nibs(((shape Convex)(sort Typ))((shape \
                   Convex)(sort Typ))))))(shards(0 1))(children(((Tile((id \
                   6664)(label(In))(mold((out Typ)(in_())(nibs(((shape \
                   Convex)(sort Typ))((shape Convex)(sort \
                   Typ))))))(shards(0))(children())))(Tile((id \
                   ...
                   6411)(label(In))(mold((out Typ)(in_())(nibs(((shape \
                   Convex)(sort Typ))((shape Convex)(sort \
                   Typ))))))(shards(0))(children())))(Tile((id \
                   ...
                   11))(sort Pat))((shape(Concave 11))(sort \
                   Typ))))))(shards(0))(children())))(Secondary((id \
                   6878)(content(Whitespace\" \"))))(Grout((id 6945)(shape \
                   ...
                   Typ)(in_(Typ))(nibs(((shape Convex)(sort Typ))((shape \
                   Convex)(sort Typ))))))(shards(0 1))(children(((Tile((id \
                   6912)(label(In))(mold((out Typ)(in_())(nibs(((shape \
                   Convex)(sort Typ))((shape Convex)(sort \
                   Typ))))))(shards(0))(children())))(Tile((id \
                ...
                backup_text =
                  "# Function literal casting regression tests #\n\
                   ...
                   let f:   ->   = fun b -> b && true in f(true);\n\
                   let f:   ->   = fun b:   -> b && true in f(true);\n\
                   let f:   ->   = fun b: Boo -> b && true in f(true); #ERR#\n\
                   ...
                   let f:   -> Bool = fun b -> b && true in f(true);\n\
                   let f:   -> Bool = fun b:   -> b && true in f(true);\n\
                   let f:   -> Bool = fun b: Boo -> b && true in f(true); \
                   #ERR#\n\n\
                   ...
                   let f:   ->   = fun b -> b && true in f(true) && true;\n\
                   let f:   ->   = fun b:   -> b && true in f(true) && true;\n\
                   let f:   ->   = fun b: Boo -> b && true in f(true) && true;\n\
                   ...
                   let f:   ->   = fun a, b -> a + 1 in f(1, 2);\n\
                   let f:   ->   = fun a:   , b  -> a + 1 in f(1, 2);\n\
                   let f:   ->   = fun a: In, b -> a + 1 in f(1, 2);\n\
                   let f:   ->   = fun (a, b): (In,  ) -> a + 1 in f(1, 2);\n\
                   let f: ( ,  ) ->   = fun a, b -> a + 1 in f(1, 2);\n\
                   let f: ( ,  ) ->   = fun a:  , b -> a + 1 in f(1, 2);\n\
                   let f: ( ,  ) ->   = fun a: In, b -> a + 1 in f(1, 2);\n\
                   let f: ( ,  ) ->   = fun (a, b): (In,  ) -> a + 1 in f(1, 2);\n\
                   ...
                   let f:   -> Int = fun a, b -> a + 1 in f(1, 2);\n\
                   let f:   -> Int = fun a:   , b  -> a + 1 in f(1, 2);\n\
                   let f:   -> Int = fun a: In, b -> a + 1 in f(1, 2);\n\
                   let f:   -> Int = fun (a, b): (In,  ) -> a + 1 in f(1, 2);\n\
                  \ \n";
              } ) );
          ( "Introduction",
            ( 15734,
              {
                zipper =
                  "((selection((focus \
                   ...
                   15500)(content(Comment\"# at the top and its evaluated \
                   result at the bottom. Right now,  #\"))))(Secondary((id \
                   14980)(content(Whitespace\"\\226\\143\\142\"))))(Secondary((id \
                   15703)(content(Comment\"# that result has a question mark, \
                   ...
                   15546)(content(Comment\"# Fill the hole below to see how \
                   ...
                   15594)(content(Comment\"# Here in Examples Mode, you can \
                   ...
                   15695)(content(Comment\"# Select Scratch Mode from the \
                   upper left dialog to access blank #\"))))(Secondary((id \
                   15252)(content(Whitespace\"\\226\\143\\142\"))))(Secondary((id \
                   15683)(content(Comment\"# cells where you can write code; \

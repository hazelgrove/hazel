    ...
    settings =
      {
        ...
        core = { statics = true; dynamics = true };
          ...
          ( 5194,
            {
              zipper =
                "((selection((focus Left)(content())(mode \
                 ...
                 Convex)(sort \
                 Exp))))))(shards(0))(children()))))((Secondary((id \
                 4816)(content(Whitespace\" \")))))))(((id 1417)(label(let = \
                 in))(mold((out Exp)(in_(Pat Exp))(nibs(((shape Convex)(sort \
                 Exp))((shape(Concave 16))(sort Exp))))))(shards((0 \
                 1)(2)))(children((((Secondary((id 1418)(content(Whitespace\" \
                 \"))))(Tile((id 1428)(label(List.map2))(mold((out \
                 ...
                 Convex)(sort \
                 Typ))))))(shards(0))(children()))))))))(Secondary((id \
                 1474)(content(Whitespace\" \"))))))())))(((Tile((id \
                 ...
                 1413)(content(Whitespace\"\\226\\143\\142\")))))((Secondary((id \

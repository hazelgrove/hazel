...
let labeled_typ: form = {
  let explanation = "Assigns a [*label*](%s) to a [*type*](%s) within a Product type. Labeled types cannot exist outside of a Product. Labeled types that are not contained within a Product are autmatically converted into a singleton product.";
  {
    id: LabeledTyp,

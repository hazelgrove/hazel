...
let term =
  ...
  shard_decos
  @ uni_lines(~line_clss, ~font_metrics, ~rows, range, tiles, ~sort)
  @ bi_lines(~line_clss, ~font_metrics, ~rows, tiles, ~sort);
};
...
let error_term =
  ...
  shard_decos
  @ uni_lines(~font_metrics, ~rows, range, tiles, ~line_clss=[], ~sort)
  @ bi_lines(~font_metrics, ~rows, tiles, ~line_clss=[], ~sort);
};

...
let self = [
  ...
  "- NOTE: Please think in small steps at first, viewing the sketch often (thus you will in turn be responding multiple times before \"submitting\"). Understand and try to learn",
  "- in these small steps exaclty how the tool calls take effect. Once you are comfortable, you may start",
  ...
  "- NOTE: Be sure to enclose each tool call in triple backticks.",

...
DESCRIPTION
       ...
       originally a port of <https://github.com/eecs490/Assignment-8-Gradescope> during W22
   ...
   bin
       ...
       join.pl : zip -> (json, json)
           ...
           returns a json pair, (token2uniqname, submissions), where submissions is keyed by token
       ...
       csv2json : csv -> json
           ...
           Intended for converting a csv token2uniqname into json, as an initial step for split.pl

       split.pl : (json, csv) -> json
           Takes token2uniqname json and splits csv into json key-value, keyed by token
       ...
       upload.pl : (json, json) -> ()
           Takes a json pair, (token2uniqname, submissions), and uploads to Gradescope

...
val final : res -> bool
(** Determines whether or not a result is {i final}, as defined in {b Figure
    11} of the ICFP 2020 paper (Appendix A). *)

val determinate : res -> bool
(** Determines whether or not a result is {i determinate}, as defined in {b
    Figure 11} of the ICFP 2020 paper (Appendix A). *)

val indeterminate : res -> bool
(** Determines whether or not a result is {i indeterminate}, as defined in {b
    Figure 11} of the ICFP 2020 paper (Appendix A). *)

%{
  ...
  let mk_subscript e1 e2 e3 = 
    let e1 = ([UHExp.ExpLine (UHExp.mk_OpSeq e1)]) in
    UHExp.subscript e1 e2 e3
...
expr:
  ...
  | expr LBRACK block COLON block RBRACK { Seq.wrap (mk_subscript $1 $3 $5) }
  | expr_ { Seq.wrap $1 }
;

...
let asserts_test =
  {|((LetLine(OpSeq(Placeholder 0)(S(Var NotInHole NotInVarHole x)E))((ExpLine(OpSeq(Placeholder 0)(S(IntLit NotInHole 1)E)))))(ExpLine(OpSeq(BinOp NotInHole Space(Placeholder 0)(Placeholder 1))(S(Keyword(AssertLit NotInHole 1))(A Space(S(Parenthesized((ExpLine(OpSeq(BinOp NotInHole Equals(Placeholder 0)(Placeholder 1))(S(Var NotInHole NotInVarHole x)(A Equals(S(EmptyHole 1)E)))))))E)))))(ExpLine(OpSeq(BinOp NotInHole Space(Placeholder 0)(Placeholder 1))(S(Keyword(AssertLit NotInHole 2))(A Space(S(Parenthesized((ExpLine(OpSeq(BinOp NotInHole Equals(Placeholder 0)(Placeholder 1))(S(Var NotInHole NotInVarHole x)(A Equals(S(IntLit NotInHole 0)E)))))))E)))))(ExpLine(OpSeq(BinOp NotInHole Space(Placeholder 0)(Placeholder 1))(S(Keyword(AssertLit NotInHole 3))(A Space(S(Parenthesized((ExpLine(OpSeq(BinOp NotInHole Equals(Placeholder 0)(Placeholder 1))(S(Var NotInHole NotInVarHole x)(A Equals(S(IntLit NotInHole 1)E)))))))E)))))(LetLine(OpSeq(Placeholder 0)(S(Var NotInHole NotInVarHole test)E))((ExpLine(OpSeq(Placeholder 0)(S(Lam NotInHole(OpSeq(Placeholder 0)(S(Var NotInHole NotInVarHole n)E))((ExpLine(OpSeq(BinOp NotInHole Space(Placeholder 0)(Placeholder 1))(S(Keyword(AssertLit NotInHole 4))(A Space(S(Parenthesized((ExpLine(OpSeq(BinOp NotInHole Equals(Placeholder 0)(Placeholder 1))(S(Var NotInHole NotInVarHole n)(A Equals(S(IntLit NotInHole 2)E)))))))E)))))))E)))))(ExpLine(OpSeq(BinOp NotInHole Space(Placeholder 0)(Placeholder 1))(S(Var NotInHole NotInVarHole test)(A Space(S(IntLit NotInHole 2)E)))))(ExpLine(OpSeq(BinOp NotInHole Space(Placeholder 0)(Placeholder 1))(S(Var NotInHole NotInVarHole test)(A Space(S(IntLit NotInHole 1)E))))))|}

...
let filter_odds =
  {|((prelude((LetLine(OpSeq(Placeholder 0)(S(TypeAnn NotInHole(Var NotInHole NotInVarHole list_eq)(OpSeq(BinOp NotInHole Arrow(Placeholder 0)(Placeholder 1))(S(Parenthesized(OpSeq(Placeholder 0)(S(List(OpSeq(Placeholder 0)(S Int E)))E)))(A Arrow(S(Parenthesized(OpSeq(BinOp NotInHole Arrow(Placeholder 0)(Placeholder 1))(S(Parenthesized(OpSeq(Placeholder 0)(S(List(OpSeq(Placeholder 0)(S Int E)))E)))(A Arrow(S(Parenthesized(OpSeq(Placeholder 0)(S Bool E)))E)))))E)))))E))((ExpLine(OpSeq(Placeholder 0)(S(Lam NotInHole(OpSeq(Placeholder 0)(S(Var NotInHole NotInVarHole xs)E))((ExpLine(OpSeq(Placeholder 0)(S(Lam NotInHole(OpSeq(Placeholder 0)(S(Var NotInHole NotInVarHole ys)E))(EmptyLine(ExpLine(OpSeq(Placeholder 0)(S(Case(StandardErrStatus NotInHole)((ExpLine(OpSeq(BinOp NotInHole Comma(Placeholder 0)(Placeholder 1))(S(Var NotInHole NotInVarHole xs)(A Comma(S(Var NotInHole NotInVarHole ys)E))))))((Rule(OpSeq(BinOp NotInHole Comma(Placeholder 0)(Placeholder 1))(S(ListNil NotInHole)(A Comma(S(ListNil NotInHole)E))))((ExpLine(OpSeq(Placeholder 0)(S(BoolLit NotInHole true)E)))))(Rule(OpSeq(BinOp NotInHole Comma(Placeholder 0)(Placeholder 1))(S(Wild NotInHole)(A Comma(S(ListNil NotInHole)E))))((ExpLine(OpSeq(Placeholder 0)(S(BoolLit NotInHole false)E)))))(Rule(OpSeq(BinOp NotInHole Comma(Placeholder 0)(Placeholder 1))(S(ListNil NotInHole)(A Comma(S(Wild NotInHole)E))))((ExpLine(OpSeq(Placeholder 0)(S(BoolLit NotInHole false)E)))))(Rule(OpSeq(BinOp NotInHole Comma(BinOp NotInHole Cons(Placeholder 0)(Placeholder 1))(BinOp NotInHole Cons(Placeholder 2)(Placeholder 3)))(S(Var NotInHole NotInVarHole x)(A Cons(S(Var NotInHole NotInVarHole xs')(A Comma(S(Var NotInHole NotInVarHole y)(A Cons(S(Var NotInHole NotInVarHole ys')E))))))))((ExpLine(OpSeq(Placeholder 0)(S(Case(StandardErrStatus NotInHole)((ExpLine(OpSeq(BinOp NotInHole Equals(Placeholder 0)(Placeholder 1))(S(Var NotInHole NotInVarHole x)(A Equals(S(Var NotInHole NotInVarHole y)E))))))((Rule(OpSeq(Placeholder 0)(S(BoolLit NotInHole true)E))((ExpLine(OpSeq(BinOp NotInHole Space(BinOp NotInHole Space(Placeholder 0)(Placeholder 1))(Placeholder 2))(S(Var NotInHole NotInVarHole list_eq)(A Space(S(Var NotInHole NotInVarHole xs')(A Space(S(Var NotInHole NotInVarHole ys')E)))))))))(Rule(OpSeq(Placeholder 0)(S(Wild NotInHole)E))((ExpLine(OpSeq(Placeholder 0)(S(BoolLit NotInHole false)E)))))))E)))))))E)))))E)))))E)))))(LetLine(OpSeq(Placeholder 0)(S(TypeAnn NotInHole(Var NotInHole NotInVarHole mod)(OpSeq(BinOp NotInHole Arrow(Placeholder 0)(BinOp NotInHole Arrow(Placeholder 1)(Placeholder 2)))(S Int(A Arrow(S Int(A Arrow(S Int E)))))))E))((ExpLine(OpSeq(Placeholder 0)(S(Lam NotInHole(OpSeq(Placeholder 0)(S(Var NotInHole NotInVarHole x)E))((ExpLine(OpSeq(Placeholder 0)(S(Lam NotInHole(OpSeq(Placeholder 0)(S(Var NotInHole NotInVarHole y)E))((ExpLine(OpSeq(Placeholder 0)(S(Case(StandardErrStatus NotInHole)((ExpLine(OpSeq(BinOp NotInHole LessThan(Placeholder 0)(Placeholder 1))(S(Var NotInHole NotInVarHole x)(A LessThan(S(Var NotInHole NotInVarHole y)E))))))((Rule(OpSeq(Placeholder 0)(S(BoolLit NotInHole true)E))((ExpLine(OpSeq(Placeholder 0)(S(Var NotInHole NotInVarHole x)E)))))(Rule(OpSeq(Placeholder 0)(S(BoolLit NotInHole false)E))((ExpLine(OpSeq(BinOp NotInHole Space(BinOp NotInHole Space(Placeholder 0)(Placeholder 1))(Placeholder 2))(S(Var NotInHole NotInVarHole mod)(A Space(S(Parenthesized((ExpLine(OpSeq(BinOp NotInHole Minus(Placeholder 0)(Placeholder 1))(S(Var NotInHole NotInVarHole x)(A Minus(S(Var NotInHole NotInVarHole y)E)))))))(A Space(S(Var NotInHole NotInVarHole y)E)))))))))))E)))))E)))))E)))))))(template(()(CursorL(OnDelim 0 Before)(LetLine(OpSeq(Placeholder 0)(S(Var NotInHole NotInVarHole filter_odds)E))((ExpLine(OpSeq(Placeholder 0)(S(Lam NotInHole(OpSeq(Placeholder 0)(S(Var NotInHole NotInVarHole xs)E))((ExpLine(OpSeq(Placeholder 0)(S(Var NotInHole NotInVarHole xs)E)))))E))))))((CommentLine"TODO: write tests here")(CommentLine"list_eq compares two lists by element")(ExpLine(OpSeq(BinOp NotInHole Space(Placeholder 0)(Placeholder 1))(S(Keyword(Typed Test NotInHole 1))(A Space(S(Parenthesized((ExpLine(OpSeq(BinOp NotInHole Space(BinOp NotInHole Space(Placeholder 0)(Placeholder 1))(Placeholder 2))(S(Var NotInHole NotInVarHole list_eq)(A Space(S(Parenthesized((ExpLine(OpSeq(BinOp NotInHole Cons(BinOp NotInHole Space(Placeholder 0)(Placeholder 1))(BinOp NotInHole Cons(Placeholder 2)(BinOp NotInHole Cons(Placeholder 3)(BinOp NotInHole Cons(Placeholder 4)(BinOp NotInHole Cons(Placeholder 5)(Placeholder 6))))))(S(Var NotInHole NotInVarHole filter_odds)(A Space(S(IntLit NotInHole 1)(A Cons(S(IntLit NotInHole 2)(A Cons(S(IntLit NotInHole 3)(A Cons(S(IntLit NotInHole 4)(A Cons(S(IntLit NotInHole 5)(A Cons(S(ListNil NotInHole)E)))))))))))))))))(A Space(S(Parenthesized((ExpLine(OpSeq(BinOp NotInHole Cons(Placeholder 0)(BinOp NotInHole Cons(Placeholder 1)(BinOp NotInHole Cons(Placeholder 2)(Placeholder 3))))(S(IntLit NotInHole 1)(A Cons(S(IntLit NotInHole 3)(A Cons(S(IntLit NotInHole 5)(A Cons(S(ListNil NotInHole)E)))))))))))E)))))))))E))))))))(tester((CommentLine"empty list")(ExpLine(OpSeq(BinOp NotInHole Space(Placeholder 0)(Placeholder 1))(S(Keyword(Typed Test NotInHole 2))(A Space(S(Parenthesized((ExpLine(OpSeq(BinOp NotInHole Space(BinOp NotInHole Space(Placeholder 0)(Placeholder 1))(Placeholder 2))(S(Var NotInHole NotInVarHole list_eq)(A Space(S(Parenthesized((ExpLine(OpSeq(BinOp NotInHole Space(Placeholder 0)(Placeholder 1))(S(Var NotInHole NotInVarHole filter_odds)(A Space(S(ListNil NotInHole)E)))))))(A Space(S(ListNil NotInHole)E)))))))))E)))))(CommentLine"all evens")(ExpLine(OpSeq(BinOp NotInHole Space(Placeholder 0)(Placeholder 1))(S(Keyword(Typed Test NotInHole 1))(A Space(S(Parenthesized((ExpLine(OpSeq(BinOp NotInHole Space(BinOp NotInHole Space(Placeholder 0)(Placeholder 1))(Placeholder 2))(S(Var NotInHole NotInVarHole list_eq)(A Space(S(Parenthesized((ExpLine(OpSeq(BinOp NotInHole Cons(BinOp NotInHole Space(Placeholder 0)(Placeholder 1))(BinOp NotInHole Cons(Placeholder 2)(BinOp NotInHole Cons(Placeholder 3)(BinOp NotInHole Cons(Placeholder 4)(Placeholder 5)))))(S(Var NotInHole NotInVarHole filter_odds)(A Space(S(IntLit NotInHole 2)(A Cons(S(IntLit NotInHole 4)(A Cons(S(IntLit NotInHole 6)(A Cons(S(IntLit NotInHole 8)(A Cons(S(ListNil NotInHole)E)))))))))))))))(A Space(S(Parenthesized((ExpLine(OpSeq(Placeholder 0)(S(ListNil NotInHole)E)))))E)))))))))E)))))(CommentLine"all odds")(ExpLine(OpSeq(BinOp NotInHole Space(Placeholder 0)(Placeholder 1))(S(Keyword(Typed Test NotInHole 2))(A Space(S(Parenthesized((ExpLine(OpSeq(BinOp NotInHole Space(BinOp NotInHole Space(Placeholder 0)(Placeholder 1))(Placeholder 2))(S(Var NotInHole NotInVarHole list_eq)(A Space(S(Parenthesized((ExpLine(OpSeq(BinOp NotInHole Cons(BinOp NotInHole Space(Placeholder 0)(Placeholder 1))(BinOp NotInHole Cons(Placeholder 2)(BinOp NotInHole Cons(Placeholder 3)(Placeholder 4))))(S(Var NotInHole NotInVarHole filter_odds)(A Space(S(IntLit NotInHole 1)(A Cons(S(IntLit NotInHole 3)(A Cons(S(IntLit NotInHole 5)(A Cons(S(ListNil NotInHole)E)))))))))))))(A Space(S(Parenthesized((ExpLine(OpSeq(BinOp NotInHole Cons(Placeholder 0)(BinOp NotInHole Cons(Placeholder 1)(BinOp NotInHole Cons(Placeholder 2)(Placeholder 3))))(S(IntLit NotInHole 1)(A Cons(S(IntLit NotInHole 3)(A Cons(S(IntLit NotInHole 5)(A Cons(S(ListNil NotInHole)E)))))))))))E)))))))))E)))))(CommentLine normal)(ExpLine(OpSeq(BinOp NotInHole Space(Placeholder 0)(Placeholder 1))(S(Keyword(Typed Test NotInHole 3))(A Space(S(Parenthesized((ExpLine(OpSeq(BinOp NotInHole Space(BinOp NotInHole Space(Placeholder 0)(Placeholder 1))(Placeholder 2))(S(Var NotInHole NotInVarHole list_eq)(A Space(S(Parenthesized((ExpLine(OpSeq(BinOp NotInHole Cons(Placeholder 0)(BinOp NotInHole Cons(Placeholder 1)(BinOp NotInHole Cons(Placeholder 2)(BinOp NotInHole Cons(Placeholder 3)(BinOp NotInHole Cons(Placeholder 4)(Placeholder 5))))))(S(IntLit NotInHole 1)(A Cons(S(IntLit NotInHole 2)(A Cons(S(IntLit NotInHole 3)(A Cons(S(IntLit NotInHole 4)(A Cons(S(IntLit NotInHole 5)(A Cons(S(ListNil NotInHole)E)))))))))))))))(A Space(S(Parenthesized((ExpLine(OpSeq(BinOp NotInHole Cons(Placeholder 0)(BinOp NotInHole Cons(Placeholder 1)(BinOp NotInHole Cons(Placeholder 2)(Placeholder 3))))(S(IntLit NotInHole 1)(A Cons(S(IntLit NotInHole 3)(A Cons(S(IntLit NotInHole 5)(A Cons(S(ListNil NotInHole)E)))))))))))E)))))))))E)))))))(id_gen(0 4))(ty(Prod())))|}
  |> Sexplib.Sexp.of_string
  |> Statics.edit_state_of_sexp;

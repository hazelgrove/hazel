...
let left_parens = no_ctrlOrCmd_alt(Key.the_key("("));
...
let ctrl_backspace = ctrl(Key.the_key("Backspace"));
...
let shift_up = shift(Key.key1(Unicode.up_arrow_key, "ArrowUp"));
let shift_down = shift(Key.key1(Unicode.down_arrow_key, "ArrowDown"));
let shift_left = shift(Key.key1(Unicode.left_arrow_key, "ArrowLeft"));
let shift_right = shift(Key.key1(Unicode.right_arrow_key, "ArrowRight"));
let ctrl_up = ctrl(Key.key1(Unicode.up_arrow_key, "ArrowUp"));
let ctrl_down = ctrl(Key.key1(Unicode.down_arrow_key, "ArrowDown"));
let ctrl_left = ctrl(Key.key1(Unicode.left_arrow_key, "ArrowLeft"));
let ctrl_right = ctrl(Key.key1(Unicode.right_arrow_key, "ArrowRight"));

...
let ctrlOrCmd_alt_i = ctrlOrCmd_alt(Key.with_code("I", "KeyI"));
let ctrlOrCmd_alt_k = ctrlOrCmd_alt(Key.with_code("K", "KeyK"));
let ctrlOrCmd_alt_j = ctrlOrCmd_alt(Key.with_code("J", "KeyJ"));
let ctrlOrCmd_alt_l = ctrlOrCmd_alt(Key.with_code("L", "KeyL"));

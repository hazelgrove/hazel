               ...
               Vdom.Event.Many([
                 ...
                 inject(
                   ModelAction.UpdateSettings(
                     CursorInspector(Toggle_strategy_guide_comp_filled_ty),
                   ),
                 ),
               ])
             ),
           ...
           [
             ...
             Attr.on_click(_ =>
               Vdom.Event.Many([
                 ...
                 inject(
                   ModelAction.UpdateSettings(
                     CursorInspector(Toggle_strategy_guide_func_filled_ty),
                   ),
                 ),
               ])
             ),
           ...
           [
             ...
             Attr.on_click(_ =>
               Vdom.Event.Many([
                 ...
                 inject(
                   ModelAction.UpdateSettings(
                     CursorInspector(Toggle_strategy_guide_pat_filled_ty),
                   ),
                 ),
               ])
             ),
           ...
           [
             ...
             Attr.on_click(_ =>
               Vdom.Event.Many([
                 ...
                 inject(
                   ModelAction.UpdateSettings(
                     CursorInspector(Toggle_strategy_guide_new_type_filled_ty),
                   ),
                 ),
               ])
             ),
           ...
           [
             ...
             Attr.on_click(_ =>
               Vdom.Event.Many([
                 ...
                 inject(
                   ModelAction.UpdateSettings(
                     CursorInspector(Toggle_strategy_guide_prim_ty),
                   ),
                 ),
               ])
             ),
           ...
           [
             ...
             Attr.on_click(_ =>
               Vdom.Event.Many([
                 ...
                 inject(
                   ModelAction.UpdateSettings(
                     CursorInspector(Toggle_strategy_guide_comp_ty),
                   ),
                 ),
               ])
             ),
           ...
           [
             ...
             Attr.on_click(_ =>
               Vdom.Event.Many([
                 ...
                 inject(
                   ModelAction.UpdateSettings(
                     CursorInspector(Toggle_strategy_guide_func_ty),
                   ),
                 ),
               ])
             ),

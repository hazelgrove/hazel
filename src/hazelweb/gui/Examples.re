...
let color =
  "((AbbrevLine $channel NotInAbbrevHole $slider((IntLit NotInHole 0)(IntLit NotInHole 255)))(LetLine(OpSeq(Placeholder 0)(S(Var NotInHole NotInVarHole baseline)E))()((ExpLine(OpSeq(Placeholder 0)(S(ApLivelit 0 NotInHole $slider $channel(57)((next 0)(splice_map())(splice_order())))E)))))(LetLine(OpSeq(Placeholder 0)(S(Var NotInHole NotInVarHole default_color)E))()((ExpLine(OpSeq(Placeholder 0)(S(ApLivelit 1 NotInHole $color $color((rgb(0 1 2))(a 3)(selecting_sat_val false))((next 4)(splice_map((0(Int((ExpLine(OpSeq(Placeholder 0)(S(Var NotInHole NotInVarHole baseline)E))))))(1(Int((ExpLine(OpSeq(BinOp NotInHole Plus(Placeholder 0)(Placeholder 1))(S(Var NotInHole NotInVarHole baseline)(A Plus(S(IntLit NotInHole 50)E))))))))(2(Int((ExpLine(OpSeq(Placeholder 0)(S(Var NotInHole NotInVarHole baseline)E))))))(3(Int((ExpLine(OpSeq(Placeholder 0)(S(ApLivelit 2 NotInHole $slider $channel(237)((next 0)(splice_map())(splice_order())))E))))))))(splice_order(0 1 2 3))))E)))))(ExpLine(OpSeq(Placeholder 0)(S(EmptyHole 49)E))))"

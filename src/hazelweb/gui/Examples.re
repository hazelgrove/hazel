...
let assistant_test =
  {|((LetLine(OpSeq(Placeholder 0)(S(Var NotInHole NotInVarHole poggle)E))((ExpLine(OpSeq(Placeholder 0)(S(FloatLit NotInHole 3.15149)E)))))(LetLine(OpSeq(Placeholder 0)(S(Var NotInHole NotInVarHole numFleens)E))((ExpLine(OpSeq(Placeholder 0)(S(IntLit NotInHole 6)E)))))(LetLine(OpSeq(Placeholder 0)(S(Var NotInHole NotInVarHole chuckles)E))((ExpLine(OpSeq(Placeholder 0)(S(BoolLit NotInHole false)E)))))(LetLine(OpSeq(Placeholder 0)(S(TypeAnn NotInHole(Var NotInHole NotInVarHole foo)(OpSeq(BinOp NotInHole Arrow(Placeholder 0)(Placeholder 1))(S Int(A Arrow(S Float E)))))E))((ExpLine(OpSeq(Placeholder 0)(S(EmptyHole 0)E)))))(LetLine(OpSeq(Placeholder 0)(S(TypeAnn NotInHole(Var NotInHole NotInVarHole bar)(OpSeq(BinOp NotInHole Arrow(Placeholder 0)(Placeholder 1))(S Float(A Arrow(S Int E)))))E))((ExpLine(OpSeq(Placeholder 0)(S(EmptyHole 1)E)))))(LetLine(OpSeq(Placeholder 0)(S(TypeAnn NotInHole(Var NotInHole NotInVarHole wizz)(OpSeq(BinOp NotInHole Arrow(Placeholder 0)(Placeholder 1))(S Int(A Arrow(S Int E)))))E))((ExpLine(OpSeq(Placeholder 0)(S(EmptyHole 24)E)))))(LetLine(OpSeq(Placeholder 0)(S(TypeAnn NotInHole(Var NotInHole NotInVarHole grog)(OpSeq(BinOp NotInHole Arrow(Placeholder 0)(Placeholder 1))(S Float(A Arrow(S Float E)))))E))((ExpLine(OpSeq(Placeholder 0)(S(EmptyHole 50)E)))))(LetLine(OpSeq(Placeholder 0)(S(Var NotInHole NotInVarHole grackle)E))((ExpLine(OpSeq(Placeholder 0)(S(Lam NotInHole(OpSeq(Placeholder 0)(S(TypeAnn NotInHole(Var NotInHole NotInVarHole r)(OpSeq(Placeholder 0)(S Float E)))E))((ExpLine(OpSeq(Placeholder 0)(S(Lam NotInHole(OpSeq(Placeholder 0)(S(TypeAnn NotInHole(Var NotInHole NotInVarHole n)(OpSeq(Placeholder 0)(S Int E)))E))((ExpLine(OpSeq(Placeholder 0)(S(IntLit NotInHole 666)E)))))E)))))E)))))(ExpLine(OpSeq(BinOp NotInHole Plus(Placeholder 0)(Placeholder 1))(S(IntLit NotInHole 1)(A Plus(S(Parenthesized((ExpLine(OpSeq(BinOp NotInHole Space(Placeholder 0)(Placeholder 1))(S(Var NotInHole NotInVarHole bar)(A Space(S(IntLit(InHole TypeInconsistent 135)4)E)))))))E))))))|}

...
module M: Projector = {
  ...
  /* Edits a literal in the syntax; nothing about it depends on a value
     computed at run time, and it holds no splices of its own. */
  let dynamics = false;

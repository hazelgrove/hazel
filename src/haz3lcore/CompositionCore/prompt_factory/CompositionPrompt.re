...
let toolkit = [
  ...
  "- `add_test(code)` — Append a `test ... end` at the end of the program. The preferred way to add tests; never use insert/selectors for this.",
  "- `update_test(match, code)` / `delete_test(match)` — Fix or remove an existing test; `match` is a unique substring of that test. Never use selectors to edit tests.",

...
let toolkit = [
  ...
  "",
  "ALWAYS use probes to verify your code after implementing a function or making changes.",
  "This is the primary way to confirm correctness. Place a probe, check the `≡` values, fix if wrong, then clean up.",
  "",
  "Use probes to:",
...
let task_planning = [
  ...
  "",
  "### 3. Verify",
  "After editing, check the context message for static (type) errors.",

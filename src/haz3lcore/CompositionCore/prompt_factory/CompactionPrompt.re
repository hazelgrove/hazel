...
let preamble_sections = [
  ...
  "(identity, guidelines, Hazel language notes, program model, toolkit, task planning, formatting,",
  ...
  "",
  "The API appends a **current** `<context>` message in the same shape Filbert gets in production:",
  "`<agentEditorView>` (program as Filbert sees it, including folds/probes as rendered),",
  "`<staticErrorsInfo>`, `<testResultsInfo>`, and `<workbenchTaskInfo>`.",
  ...
  "",
  "- **User intent** and **open problems** (what is still broken or unfinished).",
  ...
  "  **`test ... end`** outcomes, **probe** placements, **fold** / **expand** actions when they matter.",

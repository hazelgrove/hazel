...
[@@@js.stop] module HazelDoc = FlatDoc.Export.HazelDoc [@@@js.start] [@@@js.implem module HazelDoc = FlatDoc.Export.HazelDoc]
...
module RemoteCaretRemove : sig
  type t = [`RemoteCaretRemove] intf [@@js.custom { of_js=Obj.magic; to_js=Obj.magic }]
  type t_0 = t
  [@@@js.stop]
  ...
  val get_t: 'tags this -> ([`L_s6_remote_caret_remove[@js "remote-caret-remove"]] [@js.enum]) [@@js.get "t"]
  val set_t: 'tags this -> ([`L_s6_remote_caret_remove[@js "remote-caret-remove"]] [@js.enum]) -> unit [@@js.set "t"]
  val get_userId: 'tags this -> string [@@js.get "userId"]
  val set_userId: 'tags this -> string -> unit [@@js.set "userId"]
  val create: t:([`L_s6_remote_caret_remove[@js "remote-caret-remove"]] [@js.enum]) -> userId:string -> unit -> t [@@js.builder]
...
module RemoteCaret : sig
  type t = [`RemoteCaret] intf [@@js.custom { of_js=Obj.magic; to_js=Obj.magic }]
  type t_0 = t
  [@@@js.stop]
  ...
  val t_0_to_js: t_0 -> Ojs.t
  val t_0_of_js: Ojs.t -> t_0
  val get_t: 'tags this -> ([`L_s5_remote_caret[@js "remote-caret"]] [@js.enum]) [@@js.get "t"]
  val set_t: 'tags this -> ([`L_s5_remote_caret[@js "remote-caret"]] [@js.enum]) -> unit [@@js.set "t"]
  val get_userId: 'tags this -> string [@@js.get "userId"]
  val set_userId: 'tags this -> string -> unit [@@js.set "userId"]
  ...
  val get_shape: 'tags this -> ([`L_s2_left[@js "left"] | `L_s7_right[@js "right"]] [@js.enum]) option [@@js.get "shape"]
  val set_shape: 'tags this -> ([`Null | `U1 of ([`L_s2_left[@js "left"]] [@js.enum]) | `U2 of ([`L_s7_right[@js "right"]] [@js.enum])] [@js.union]) -> unit [@@js.set "shape"]
  val get_side: 'tags this -> ([`L_s2_left[@js "left"] | `L_s7_right[@js "right"]] [@js.enum]) option [@@js.get "side"]
  val set_side: 'tags this -> ([`Null | `U1 of ([`L_s2_left[@js "left"]] [@js.enum]) | `U2 of ([`L_s7_right[@js "right"]] [@js.enum])] [@js.union]) -> unit [@@js.set "side"]
  val create: t:([`L_s5_remote_caret[@js "remote-caret"]] [@js.enum]) -> userId:string -> ?userName:string -> color:string -> pieceId:string -> ?shardIdx:int -> caretOffset:int -> ?shape:([`L_s2_left[@js "left"] | `L_s7_right[@js "right"]] [@js.enum]) -> ?side:([`L_s2_left[@js "left"] | `L_s7_right[@js "right"]] [@js.enum]) -> unit -> t [@@js.builder]
  val cast_from: 'tags this -> t [@@js.custom let cast_from = Obj.magic]
end
...
module Pong : sig
  ...
  val t_0_to_js: t_0 -> Ojs.t
  val t_0_of_js: Ojs.t -> t_0
  val get_t: 'tags this -> ([`L_s4_pong[@js "pong"]] [@js.enum]) [@@js.get "t"]
  val set_t: 'tags this -> ([`L_s4_pong[@js "pong"]] [@js.enum]) -> unit [@@js.set "t"]
  val get_message: 'tags this -> string [@@js.get "message"]
  val set_message: 'tags this -> string -> unit [@@js.set "message"]
  val create: t:([`L_s4_pong[@js "pong"]] [@js.enum]) -> message:string -> unit -> t [@@js.builder]
  val cast_from: 'tags this -> t [@@js.custom let cast_from = Obj.magic]
end
...
module Ping : sig
  ...
  val t_0_to_js: t_0 -> Ojs.t
  val t_0_of_js: Ojs.t -> t_0
  val get_t: 'tags this -> ([`L_s3_ping[@js "ping"]] [@js.enum]) [@@js.get "t"]
  val set_t: 'tags this -> ([`L_s3_ping[@js "ping"]] [@js.enum]) -> unit [@@js.set "t"]
  val get_message: 'tags this -> string [@@js.get "message"]
  val set_message: 'tags this -> string -> unit [@@js.set "message"]
  val create: t:([`L_s3_ping[@js "ping"]] [@js.enum]) -> message:string -> unit -> t [@@js.builder]
  val cast_from: 'tags this -> t [@@js.custom let cast_from = Obj.magic]
end
...
module EditorState : sig
  type t = [`EditorState] intf [@@js.custom { of_js=Obj.magic; to_js=Obj.magic }]
  type t_0 = t
  [@@@js.stop]
  ...
  val t_0_to_js: t_0 -> Ojs.t
  val t_0_of_js: Ojs.t -> t_0
  val get_t: 'tags this -> ([`L_s8_state[@js "state"]] [@js.enum]) [@@js.get "t"]
  val set_t: 'tags this -> ([`L_s8_state[@js "state"]] [@js.enum]) -> unit [@@js.set "t"]
  ...
  val create: t:([`L_s8_state[@js "state"]] [@js.enum]) -> state:HazelDoc.t_0 -> ?deleted:string list -> unit -> t [@@js.builder]
  val cast_from: 'tags this -> t [@@js.custom let cast_from = Obj.magic]
end

(** Messages sent from parent (Patchwork) to Hazel iframe *)
module ParentToHazel : sig
  type t = ([`U_s3_ping of Ping.t [@js "ping"] | `U_s4_pong of Pong.t [@js "pong"] | `U_s5_remote_caret of RemoteCaret.t [@js "remote-caret"] | `U_s6_remote_caret_remove of RemoteCaretRemove.t [@js "remote-caret-remove"] | `U_s8_state of EditorState.t [@js "state"]] [@js.union on_field "t"])
  type t_0 = t
  val t_to_js: t -> Ojs.t
  val t_of_js: Ojs.t -> t
  val t_0_to_js: t_0 -> Ojs.t
...
(**
  ...
  - shardIdx: For tiles, which shard (delimiter) of the tile. null for non-tiles.
                ...
                We need shardFlatDoc to look up the correct shard's measurement.
...
module CaretUpdate : sig
  type t = [`CaretUpdate] intf [@@js.custom { of_js=Obj.magic; to_js=Obj.magic }]
  type t_0 = t
  [@@@js.stop]
  ...
  val t_0_to_js: t_0 -> Ojs.t
  val t_0_of_js: Ojs.t -> t_0
  val get_t: 'tags this -> ([`L_s0_caret[@js "caret"]] [@js.enum]) [@@js.get "t"]
  val set_t: 'tags this -> ([`L_s0_caret[@js "caret"]] [@js.enum]) -> unit [@@js.set "t"]
  val get_pieceId: 'tags this -> string [@@js.get "pieceId"]
  val set_pieceId: 'tags this -> string -> unit [@@js.set "pieceId"]
  val get_shardIdx: 'tags this -> int option [@@js.get "shardIdx"]
  val set_shardIdx: 'tags this -> int option -> unit [@@js.set "shardIdx"]
  ...
  val get_side: 'tags this -> ([`L_s2_left[@js "left"] | `L_s7_right[@js "right"]] [@js.enum]) option [@@js.get "side"]
  val set_side: 'tags this -> ([`Null | `U1 of ([`L_s2_left[@js "left"]] [@js.enum]) | `U2 of ([`L_s7_right[@js "right"]] [@js.enum])] [@js.union]) -> unit [@@js.set "side"]
  val create: t:([`L_s0_caret[@js "caret"]] [@js.enum]) -> pieceId:string -> ?shardIdx:int -> caretOffset:int -> ?shape:([`L_s2_left[@js "left"] | `L_s7_right[@js "right"]] [@js.enum]) -> ?side:([`L_s2_left[@js "left"] | `L_s7_right[@js "right"]] [@js.enum]) -> unit -> t [@@js.builder]
  val cast_from: 'tags this -> t [@@js.custom let cast_from = Obj.magic]
end

(** Messages sent from Hazel iframe to parent (Patchwork) *)
module HazelToParent : sig
  type t = ([`U_s0_caret of CaretUpdate.t [@js "caret"] | `U_s1_init of Init.t [@js "init"] | `U_s3_ping of Ping.t [@js "ping"] | `U_s4_pong of Pong.t [@js "pong"] | `U_s8_state of EditorState.t [@js "state"]] [@js.union on_field "t"])
  type t_0 = t
  val t_to_js: t -> Ojs.t
  val t_of_js: Ojs.t -> t
  val t_0_to_js: t_0 -> Ojs.t
...
module Export : sig
  ...
  [@@@js.stop] module EditorState = EditorState [@@@js.start] [@@@js.implem module EditorState = EditorState]
  (* export interface CaretUpdate *)
  [@@@js.stop] module CaretUpdate = CaretUpdate [@@@js.start] [@@@js.implem module CaretUpdate = CaretUpdate]
  (* export interface RemoteCaret *)
  [@@@js.stop] module RemoteCaret = RemoteCaret [@@@js.start] [@@@js.implem module RemoteCaret = RemoteCaret]
  (* export interface RemoteCaretRemove *)
  [@@@js.stop] module RemoteCaretRemove = RemoteCaretRemove [@@@js.start] [@@@js.implem module RemoteCaretRemove = RemoteCaretRemove]

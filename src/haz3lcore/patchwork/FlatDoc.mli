...
module SecondaryContent : sig
  ...
  val get_t :
    'tags this ->
    ([ `L_s16_Whitespace [@js "Whitespace"] | `L_s1_Comment [@js "Comment"] ]
    [@js.enum])
  [@@js.get "t"]
...
module Secondary : sig
  ...
  val get_t : 'tags this -> ([ `L_s11_Secondary [@js "Secondary"] ][@js.enum])
  [@@js.get "t"]
  ...
  val create :
    t:([ `L_s11_Secondary [@js "Secondary"] ][@js.enum]) ->
    id:UUID.t ->
...
module FlatTile : sig
  ...
  val get_t : 'tags this -> ([ `L_s14_Tile [@js "Tile"] ][@js.enum])
  [@@js.get "t"]
...
module FlatProjector : sig
  ...
  val get_t : 'tags this -> ([ `L_s9_Projector [@js "Projector"] ][@js.enum])
  [@@js.get "t"]
  ...
  val create :
    t:([ `L_s9_Projector [@js "Projector"] ][@js.enum]) ->
    id:UUID.t ->
    kind:string ->
    syntax:UUID.t ->
    model:string ->
...
module FlatPiece : sig
  type t =
    ([ `U_s5_Grout of Grout.t [@js "Grout"]
     | `U_s9_Projector of FlatProjector.t [@js "Projector"]
     | `U_s11_Secondary of Secondary.t [@js "Secondary"]
     | `U_s14_Tile of FlatTile.t [@js "Tile"] ]
    [@js.union on_field "t"])

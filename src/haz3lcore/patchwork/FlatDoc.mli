...
module SecondaryContent : sig
  type t = [`SecondaryContent] intf [@@js.custom { of_js=Obj.magic; to_js=Obj.magic }]
  type t_0 = t
  [@@@js.stop]
  ...
  val get_t: 'tags this -> ([`L_s16_Whitespace[@js "Whitespace"] | `L_s1_Comment[@js "Comment"]] [@js.enum]) [@@js.get "t"]
  val get_content: 'tags this -> string [@@js.get "content"]
  val create: t:([`L_s16_Whitespace[@js "Whitespace"] | `L_s1_Comment[@js "Comment"]] [@js.enum]) -> content:string -> unit -> t [@@js.builder]
...
module Secondary : sig
  type t = [`Secondary] intf [@@js.custom { of_js=Obj.magic; to_js=Obj.magic }]
  type t_0 = t
  [@@@js.stop]
  type tags = [`Secondary]
  type tags_0 = tags
  ...
  val t_0_to_js: t_0 -> Ojs.t
  val t_0_of_js: Ojs.t -> t_0
  val get_t: 'tags this -> ([`L_s11_Secondary[@js "Secondary"]] [@js.enum]) [@@js.get "t"]
  val get_id: 'tags this -> UUID.t [@@js.get "id"]
  val get_content: 'tags this -> SecondaryContent.t [@@js.get "content"]
  val create: t:([`L_s11_Secondary[@js "Secondary"]] [@js.enum]) -> id:UUID.t -> content:SecondaryContent.t -> unit -> t [@@js.builder]
  val cast_from: 'tags this -> t [@@js.custom let cast_from = Obj.magic]
end

(** Shape of a grout piece (hole) *)
module Shape : sig
  type t = ([`L_s2_Concave[@js "Concave"] | `L_s3_Convex[@js "Convex"]] [@js.enum])
  type t_0 = t
  val t_to_js: t -> Ojs.t
  val t_of_js: Ojs.t -> t
  val t_0_to_js: t_0 -> Ojs.t
...
module Grout : sig
  type t = [`Grout] intf [@@js.custom { of_js=Obj.magic; to_js=Obj.magic }]
  type t_0 = t
  [@@@js.stop]
  type tags = [`Grout]
  type tags_0 = tags
  ...
  val t_0_to_js: t_0 -> Ojs.t
  val t_0_of_js: Ojs.t -> t_0
  val get_t: 'tags this -> ([`L_s5_Grout[@js "Grout"]] [@js.enum]) [@@js.get "t"]
  val get_id: 'tags this -> UUID.t [@@js.get "id"]
  val get_shape: 'tags this -> Shape.t [@@js.get "shape"]
  val create: t:([`L_s5_Grout[@js "Grout"]] [@js.enum]) -> id:UUID.t -> shape:Shape.t -> unit -> t [@@js.builder]
  val cast_from: 'tags this -> t [@@js.custom let cast_from = Obj.magic]
end

(** Hazel syntactic sorts - the grammatical categories of the language *)
module Sort : sig
  type t = ([`L_s0_Any[@js "Any"] | `L_s10_Rul[@js "Rul"] | `L_s12_Sig[@js "Sig"] | `L_s13_TPat[@js "TPat"] | `L_s15_Typ[@js "Typ"] | `L_s4_Exp[@js "Exp"] | `L_s6_MPat[@js "MPat"] | `L_s7_Mod[@js "Mod"] | `L_s8_Pat[@js "Pat"]] [@js.enum])
  type t_0 = t
  val t_to_js: t -> Ojs.t
  val t_of_js: Ojs.t -> t
  val t_0_to_js: t_0 -> Ojs.t
...
module NibShape : sig
  module rec AnonymousInterface0 : sig
    ...
    val t_to_js: t -> Ojs.t
    val t_of_js: Ojs.t -> t
    val get_t: t -> ([`L_s2_Concave[@js "Concave"]] [@js.enum]) [@@js.get "t"]
    val set_t: t -> ([`L_s2_Concave[@js "Concave"]] [@js.enum]) -> unit [@@js.set "t"]
    val get_n: t -> int [@@js.get "n"]
    val set_n: t -> int -> unit [@@js.set "n"]
    val create: t:([`L_s2_Concave[@js "Concave"]] [@js.enum]) -> n:int -> unit -> t [@@js.builder]
  end
  and AnonymousInterface1 : sig
    ...
    val set_t: t -> ([`L_s3_Convex[@js "Convex"]] [@js.enum]) -> unit [@@js.set "t"]
    val create: t:([`L_s3_Convex[@js "Convex"]] [@js.enum]) -> unit -> t [@@js.builder]
  end
  type t = ([`U_s2_Concave of AnonymousInterface0.t [@js "Concave"] | `U_s3_Convex of AnonymousInterface1.t [@js "Convex"]] [@js.union on_field "t"])
  type t_0 = t
  val t_to_js: t -> Ojs.t
  val t_of_js: Ojs.t -> t
  val t_0_to_js: t_0 -> Ojs.t
...
*)
module FlatTile : sig
  type t = [`FlatTile] intf [@@js.custom { of_js=Obj.magic; to_js=Obj.magic }]
  type t_0 = t
  [@@@js.stop]
  type tags = [`FlatTile]
  type tags_0 = tags
  ...
  val t_0_to_js: t_0 -> Ojs.t
  val t_0_of_js: Ojs.t -> t_0
  val get_t: 'tags this -> ([`L_s14_Tile[@js "Tile"]] [@js.enum]) [@@js.get "t"]
  val get_id: 'tags this -> UUID.t [@@js.get "id"]
  ...
  val create: t:([`L_s14_Tile[@js "Tile"]] [@js.enum]) -> id:UUID.t -> label:string list -> mold:Mold.t -> shards:int list -> children:UUID.t list list -> unit -> t [@@js.builder]
  val cast_from: 'tags this -> t [@@js.custom let cast_from = Obj.magic]
end
...
module FlatProjector : sig
  type t = [`FlatProjector] intf [@@js.custom { of_js=Obj.magic; to_js=Obj.magic }]
  type t_0 = t
  [@@@js.stop]
  ...
  val t_0_to_js: t_0 -> Ojs.t
  val t_0_of_js: Ojs.t -> t_0
  val get_t: 'tags this -> ([`L_s9_Projector[@js "Projector"]] [@js.enum]) [@@js.get "t"]
  val get_id: 'tags this -> UUID.t [@@js.get "id"]
  ...
  val create: t:([`L_s9_Projector[@js "Projector"]] [@js.enum]) -> id:UUID.t -> kind:string -> syntax:UUID.t -> model:string -> unit -> t [@@js.builder]
  val cast_from: 'tags this -> t [@@js.custom let cast_from = Obj.magic]
end

(** A piece in the flat document - either a tile, grout, secondary, or projector *)
module FlatPiece : sig
  type t = ([`U_s5_Grout of Grout.t [@js "Grout"] | `U_s9_Projector of FlatProjector.t [@js "Projector"] | `U_s11_Secondary of Secondary.t [@js "Secondary"] | `U_s14_Tile of FlatTile.t [@js "Tile"]] [@js.union on_field "t"])
  type t_0 = t
  val t_to_js: t -> Ojs.t
  val t_of_js: Ojs.t -> t
  val t_0_to_js: t_0 -> Ojs.t
...
module Export : sig
  ...
  [@@@js.stop] module FlatTile = FlatTile [@@@js.start] [@@@js.implem module FlatTile = FlatTile]
  (* export interface FlatProjector *)
  [@@@js.stop] module FlatProjector = FlatProjector [@@@js.start] [@@@js.implem module FlatProjector = FlatProjector]
  (* export type FlatPiece *)
  [@@@js.stop] module FlatPiece = FlatPiece [@@@js.start] [@@@js.implem module FlatPiece = FlatPiece]
  (* export type HazelDoc *)
  [@@@js.stop] module HazelDoc = HazelDoc [@@@js.start] [@@@js.implem module HazelDoc = HazelDoc]
end
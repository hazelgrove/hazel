 ...
 * projector syntax or splice content — those belong to nested viewports
 * (the projector's own view, or the splice's inner editor). The
 * projector/splice piece's own id is included so outer decorations
 * targeting the projector/splice itself still apply. */

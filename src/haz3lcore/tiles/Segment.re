  ...
  | [hd, ...tl] =>
    ...
    | Projector(p) =>
      let (remolded, shape, rest) =
        remold_typ_uni(snd(ProjectorBase.shapes_p(p)), tl, parent_sorts);
      ([hd, ...remolded], shape, rest);
    | Tile(t) =>
      switch (remold_tile(Typ, shape, t)) {
      | None => ([], shape, seg)
...
and remold_pat_uni = (shape, seg: t, parent_sorts): (t, Nib.Shape.t, t) =>
  ...
  | [hd, ...tl] =>
    ...
    | Projector(p) =>
      let (remolded, shape, rest) =
        remold_pat_uni(snd(ProjectorBase.shapes_p(p)), tl, parent_sorts);
      ([hd, ...remolded], shape, rest);
    | Tile(t) =>
...
and remold_tpat_uni = (shape, seg: t, parent_sorts): (t, Nib.Shape.t, t) =>
  ...
  | [hd, ...tl] =>
    ...
    | Projector(p) =>
      let (remolded, shape, rest) =
        remold_tpat_uni(snd(ProjectorBase.shapes_p(p)), tl, parent_sorts);
      ([hd, ...remolded], shape, rest);
    | Tile(t) =>
...
and remold_exp_uni = (shape, seg: t, parent_sorts): (t, Nib.Shape.t, t) =>
  ...
  | [hd, ...tl] =>
    ...
    | Projector(p) =>
      let (remolded, shape, rest) =
        remold_exp_uni(snd(ProjectorBase.shapes_p(p)), tl, parent_sorts);
      ([hd, ...remolded], shape, rest);
    | Tile(t) =>

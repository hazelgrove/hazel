    ...
    | Ap(t1,t2) => 
       ...
       let arg =
         ...
         | _ => ""
          ...
          //not sure if i need to worry about removing AP here.
          let (ty_def, ctx_def, ctx_body) = {

              //extend ctx for our first parameter
              let temp_ctx = Ctx.extend_dummy_tvar(ctx,  (Var(name):TPat.term) |> IdTagged.fresh);

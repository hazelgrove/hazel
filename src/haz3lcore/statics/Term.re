module Pat = {
  ...
  let rec is_tuple_of_arrows = (pat: t) =>
    ...
    || (
      switch (pat.term) {
      | Wrap(pat, _) => is_tuple_of_arrows(pat)
...
module Exp = {
  ...
  let rec is_tuple_of_functions = (e: t) =>
    ...
    || (
      switch (e.term) {
      | Cast(e, _, _)
      | Wrap(e, _) => is_tuple_of_functions(e)
  ...
  let rec get_num_of_functions = (e: t) =>
    if (is_fun(e)) {
      ...
      switch (e.term) {
      | Wrap(e, _) => get_num_of_functions(e)

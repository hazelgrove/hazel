...
module Tile : sig
  ...
  val get_t : 'tags this -> ([ `L_s4_Tile [@js "Tile"] ][@js.enum])
  [@@js.get "t"]
...
module InsertOp : sig
  ...
  val get_t : 'tags this -> ([ `L_s3_Insert [@js "Insert"] ][@js.enum])
  [@@js.get "t"]
  ...
  val create :
    t:([ `L_s3_Insert [@js "Insert"] ][@js.enum]) ->
    uuid:UUID.t ->
    index:float ->
    tiles:Tile.t list ->
    unit ->
...
module DeleteOp : sig
  ...
  val get_t : 'tags this -> ([ `L_s1_Delete [@js "Delete"] ][@js.enum])
  [@@js.get "t"]
  ...
  val create :
    t:([ `L_s1_Delete [@js "Delete"] ][@js.enum]) ->
    uuid:UUID.t ->
    index:float ->
    unit ->
    t
...
module EditOp : sig
  type t =
    ([ `U_s1_Delete of DeleteOp.t [@js "Delete"]
     | `U_s3_Insert of InsertOp.t [@js "Insert"] ]
    [@js.union on_field "t"])

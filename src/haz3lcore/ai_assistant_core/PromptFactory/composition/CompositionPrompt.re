...
let toolkit = [
  ...
  "1. View: These tools are used to view the AST/program itslef. They primarily operate on the tree-based structure of the file system and AST. You should use these to expand and collapse defintiions (almost as if they were folders/files).",
  ". These will never modify the program.\n",
  ...
  "view and read tools to understand the code and provide and thoughtful response.",
  ...
  "In any case, you should use view tools and read tools to view the relevant parts and defintions (let expressions) of the program as necessary.",

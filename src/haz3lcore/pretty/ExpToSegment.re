      ...
      [
        Piece.Projector(
          ProjectorCore.mk(
            ...
            /* A projector's syntax became a SEGMENT on this branch (it has
               to be able to hold splices); `syntax` here is a single piece,
               so it is lifted rather than passed through. */
            [syntax],
            model,
          ),
        ),

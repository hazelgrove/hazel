...
/* Drop the innermost ancestor, splicing its siblings around the current
 * ones. Used when removing a parent tile without disturbing its
 * contents (Zipper.delete_parent). */

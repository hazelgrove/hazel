...
module Make = (M: Move.S) => {
  ...
  let parent_cls = (z: Zipper.t('p), info_map: Semantics.Statics.Map.t) => {
    let* id = Indicated.index(z);
  ...
  let parent_is_rule =
      (z: Zipper.t('p), info_map: Semantics.Statics.Map.t): option(Id.t) => {
  ...
  let parent_id = (z: Zipper.t('p), info_map: Semantics.Statics.Map.t) => {
  ...
  let parent_of_indicated =
      (z: Zipper.t('p), info_map: Semantics.Statics.Map.t) => {
